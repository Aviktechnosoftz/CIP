...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="control-label rightpadding"><span class="form-name">Approved Site Attendance Form&nbsp;<?// echo $project_name->project_name ?> </span></label>
      ...
      <div class="form-group">
        ...
        <!--         <td><? $value= str_pad($row->induction_no, 4, '0', STR_PAD_LEFT); echo $value; ?></td> -->
                ...
                <td><? echo $row->Name?></td>
                    <td><? if($row->Type=="App")
    { ?>
    <img src="image/app2.gif" height="31vh" width="20vw" style="margin-left: 0.4vw">
    <? }
    else{ ?>
  <img src="image/web2.gif" height="32vh" width="30vw">
   <? } ?></td>
                <td>
                  <form id="site_attendance_form<?=$row->id?>" method="post" action="site_attendance_approved_form.php" >
                  <input type="hidden"  name="attendance_form" value="<?=$row->id?>" />
