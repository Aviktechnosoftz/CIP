...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="control-label rightpadding"><span class="form-name">Sign Out Visitor Induction Form&nbsp;<?// echo $project_name->project_name ?> </span></label>
        ...
        <tr style="background-color: #696969; color: white">
         ...
         <tbody style="" id='user'>
              ...
              <tr style="background-color: #f5f5f5; font-size: 15px"> 
                ...
                <td>
                  <form id="visitor_form_out<?=$row->visit_id?>" method="post" action="visitor_induction_form_sign_out.php" >
                  <input type="hidden"  name="visitor_form" value="<?=$row->visit_id?>" />
                  <input type="submit" class="btn btn-primary" class="button edit_click1" value="Review Form" style="cursor:pointer; width: 8vw; background-color:#f47821;color: white;border:none;border-radius:10vh;outline: none; border:none; outline: none;font-size: 1.6vh" /> 
                </form>  
                </td>
