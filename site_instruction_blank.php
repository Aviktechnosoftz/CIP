...
$name= $name.",".str_replace(' ','_', $building_images_1);
}
...
$name=$name.",". str_replace(' ','_', $building_images_2);
}
...
$name= $name.",".str_replace(' ','_', $building_images_3);
}
                ...
                <div class="col-md-12 zeropadding">
                  <div class="input-group">
                    ...
                    <select  class="form-control selectpicker"   id="subcontractor_name" name="subcontractor_name" required onchange="emp()" required style="font-size: 1.8vh">
                      ...
                      <? $employer= $conn->query("select * from tbl_employer where is_deleted=0 AND project_id=".$_SESSION['admin']." order by company_name");
...
-->
          <div class="form-group">
            <div class="col-md-6 rightpadding">  
              <label class="col-md-12 control-label label-position">Telephone
              </label>
              <div class="col-md-12 zeropadding" >
                <div class="input-group">
                  <span class="input-group-addon">
...
<option value=""> Please Select Employee</option>
          ...
          <div class="form-group"> 
            <div class="col-md-12 zeropadding"> 
              <label class="col-md-12 control-label label-position">Instructions
              </label>
              <div class="col-md-12 zeropadding">
                ...
                <div class="input-group col-md-12">
                  ...
                  <textarea class="form-control instruction_area" rows="10" id="comment" name="instruction" style="-webkit-border-radius: 15px !important;-moz-border-radius: 15px !important;border-radius: 15px !important;font-size: 12px;resize: none " >
                  </textarea>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-12 zeropadding"> 
              ...
              <div class="col-md-12 zeropadding">
                ...
                <div class="input-group col-md-12">
                  ...
                  <div style="padding-left: 10px;font-size: 13px;font-family: 'Avenirnext' !important; display: none" id="title_sub">You Must Comply With The Following Subcontract Clauses
              </div>
          ...
          <div class="form-group">
            <div class="col-md-12 zeropadding"> 
              <div class="col-sm-3" style="">
              	...
              	<div class="col-sm-1">
									<span class="glyphicon glyphicon-eye-open" id="clickme" data-toggle="modal" data-target="#myModalPic" onclick="getImg();" style="display:none;    left: 30px;position:relative;"></span>
              	</div>                
              ...
              <div class="col-sm-3 text-center">
              	...
              	<div class="col-sm-1">
              		<span class="glyphicon glyphicon-eye-open" id="clickme2" data-toggle="modal" data-target="#myModalPic" onclick="getImg2();" style="display:none;left: 30px;position:relative;"></span>
              	</div>
              ...
              <div class="col-sm-3 text-center">
              	...
              	<div class="col-sm-1">
                	<span class="glyphicon glyphicon-eye-open" id="clickme3" data-toggle="modal" data-target="#myModalPic" onclick="getImg3();" style="display:none;left: 30px;position:relative;"></span>
                </div>
              ...
              <div class="col-sm-3 text-center">
                ...
                <input type="file" name="photo[]" id="file_4" onchange="document.getElementById('upload_4').src = window.URL.createObjectURL(this.files[0]); $('#desc4').show();$('#desc4').attr('required', true);$('#clickme4').show();">
              	...
              	<div class="col-sm-1">
                	<span class="glyphicon glyphicon-eye-open" id="clickme4" data-toggle="modal" data-target="#myModalPic" onclick="getImg4();" style="display:none;left: 30px;position:relative;"></span>
              	</div>
      			...
      			<!-- Modal content-->
      				<div class="modal-content">
        				<div class="modal-body">
        					<button type="button" class="close" data-dismiss="modal" style="color: black !important; float: right;z-index: 1000">&times;</button>
            ...
            <div class="col-md-12 zeropadding"> 
              <div class="col-md-12 zeropadding">
                <div class="input-group" >
                 ...
                 <textarea class="form-control" title="Please Enter Email Description
" rows="10" id="email_msg" name="email_msg"   style="-webkit-border-radius: 15px !important;-moz-border-radius: 15px !important;border-radius: 15px !important;font-size: 12px;background-color: #fff !important;resize: none;border: solid 1px #ccc !important; " > 
                  </textarea>
    ...
    <div class="modal fade" id="myModalNorm" tabindex="-1" role="dialog" 
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          //Chosen
          //Select2
          $('#email_msg').css('background','white');
