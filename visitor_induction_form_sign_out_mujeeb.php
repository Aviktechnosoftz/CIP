...
if(isset($_POST['signout']))
{
	...
	$visitor_update=$conn->query("update tbl_visitor_induction set visit_out='".$_POST['time_out']."',updated=NOW() where id='".$_POST['id']."'");
  if($visitor_update)
  {
    ?>
    <script>
...
<div class="main_form_header">
  ...
  <div class="col-md-6 main_title_container">
      ...
      <label class="col-md-12 control-label form-name">VISITOR INDUCTION FORM</label>
  ...
  <input name="time_out" placeholder="Time Out" class="form-control" id="DivTag" type="text" readonly>
      ...
      <div class="form-group">
        <div class="col-md-6 rightpadding">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
            <input name="last_name" placeholder="Employer Name" class="test"  type="text" value="<? echo $get_query->visit_in; ?>" readonly>
          </div>
        </div>
       <div class="col-md-6 leftpadding">
          <div class="input-group">
