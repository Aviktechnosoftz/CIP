...
if(isset($_POST['save_later']))
{
     ...
     $name="";
        ...
        if($_FILES['photo']['name'][1]!="")
         ...
         $path_parts1 = pathinfo($_FILES['photo']['name'][1]);
        $building_images_1 = $path_parts1['filename'].'_'.time().'.'.$path_parts1['extension'];
        $name= $name.",".$building_images_1;
         }
         if($_FILES['photo']['name'][2]!="")
          {
         $path_parts2 = pathinfo($_FILES['photo']['name'][2]);
        $building_images_2 = $path_parts2['filename'].'_'.time().'.'.$pathz_parts2['extension'];
        $name= $name.",".$building_images_2;
         }
         if($_FILES['photo']['name'][3]!="")
          {
         $path_parts3 = pathinfo($_FILES['photo']['name'][3]);
        $building_images_3 = $path_parts3['filename'].'_'.time().'.'.$path_parts3['extension'];
        $name= $name.",".$building_images_3;
        }
        $name = ltrim($name,",");
  ...
  if($qry_save)
                {
                  ...
                  window.location.href='site_instruction_saved.php';</script>
                  <?
                }  
}
...
var loadFile6 = function(event) {
    ...
    if(newimg.indexOf('/null') > -1) {
      ...
      $('#desc3').attr('required', true);document.getElementById('viewer3').style.display = 'block';">
              ...
              <span class="glyphicon glyphicon-eye-open" id="viewer4" style="display:none;left:20px;position:relative;top:25px"></span>
...
<div class="modal fade" id="termsModal" tabindex="-1" role="dialog" aria-labelledby="Terms and conditions" aria-hidden="true">
    <div class="modal-dialog">
      ...
      <span class="spantoinput"><input type="checkbox" value="2.1."  class="clause inputtolabel">&nbsp;&nbsp;&nbsp;&nbsp;<b>2.1. Access and Scheduling</b></span>
      ...
      <span class="spantoinput"><input type="checkbox" value="2.4."  class="clause inputtolabel">&nbsp;&nbsp;&nbsp;&nbsp;<b>2.4. Directions</b></span>
      ...
      <span class="spantoinput"><input type="checkbox" value="5.7."  class="clause inputtolabel">&nbsp;&nbsp;&nbsp;&nbsp;<b>5.7. Testing</b></span>
...
function terms_check()
{
 ...
 // console.log( val);
var textArray= {"2.1.":"Access and Scheduling",
