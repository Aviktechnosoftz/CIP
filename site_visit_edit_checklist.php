...
<div class="bluebackground mobilebackground col-md-12 col-sm-12" style="padding-right: 0px; padding-left: 0px">
  ...
  <div class="col-md-12 col-sm-12" style="padding-top: 3vh;padding-left: 0px;">
    <div class="col-md-4 col-xs-6 main_title_container" style="padding-left: 10px !important;">
      ...
      <div class="col-sm-4 col-md-4 datetop " style="margin-top: 10vh;p">
...
<?
    ...
    <div class="col-sm-12" >
      ...
      <div class="col-sm-4">
        <label class="label_blue">Name</label></center>
    ...
    <div class="col-md-4 submitaction" style="margin-top: 5px;width: 15%;float: right;margin-right: 25px;">
      <input type="button" id="submit_later" name="save_later" value="Submit" class="btn btn-warning form_submit_button"  style=" height: 37px!important;" onclick="save_checklist('<? echo $udid_edit_date; ?>')">
    </div>
    </div>
     </div>
          </div>
...
// });
  ...
  $(document).on("click", "#mod_btn_3", function () {
    ...
    $('.mod_btn_3_modalbackground').css('background-color','white');
    //$('.form-control-left-radius').css('padding-top','0px');
    $('#action_comment_temp2').css('background-color','white');
  ...
  $(document).on("click", "#mod_btn_2", function () {
    ...
    var task_name= $(this).data('task');
     $(".modal-body #action_comment_temp").css('color','#FF0000');
...
<style>
  ...
  .form_submit_button{
        background-color: #EE621A!important;
  }
  div.tab 
  {
    overflow: hidden;
