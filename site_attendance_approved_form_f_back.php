        ...
        <form class="well form-horizontal well_class" method="post"  id="contact_form" action="test_image_gallery.php" enctype="multipart/form-data">
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-md-12 zeropadding">    
                <textarea class="form-control worker-location" name="comment" id="loc" placeholder="3 men working in the main warehouse pouring slab 273 men digging the stormwater trench to main carpark 2 men installing bollards to doorways D38 & D36" readonly><? echo $get_query->employees_location  ?></textarea>
              </div>
            </div>
         ...
         <img class="preview" id="preview6"  <? if($get_query->image_6!="") { echo 'src=API/Uploads/'.$get_query->image_6;} ?>  style=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block;">
          ...
          <Script>
            ...
            <div class="form-group">
              ...
              <div class="col-md-2 text-center" style="padding-left: 0px">
                <!-- <input type="file" name="photo[]" id="imgInp" onchange="loadFile2(event);">
                <img class="preview" id="preview2" sty        le=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block;"> -->
            ...
            <script>
              function onerrorfun(id) 
              {
                ...
                $('#upload_'+id).attr('src','Document.png');
              }
            </script>
