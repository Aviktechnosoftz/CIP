...
foreach ($_POST['data'] as $key => $value) {
	$contact= $conn->query("select * from tbl_consultant where id='".$value."'")->fetch_object();
	...
	$vcard_text.= "BEGIN:VCARD%0AVERSION:2.1%0AN:".$contact->consultant_name.";;;;%0AFN:".$contact->consultant_name."%0ATEL;HOME:".$contact->phone_no."%0AEMAIL:".$contact->email_add."%0Aitem1.ADR;type=WORK;type=pref:;;".$contact->address."%0AEND:VCARD";
	$vcard_text.="%0A";

}

$subject= $_SESSION['project_name']."-Consultant%20Contact%20Details";
$opts = array(
  'http'=>array(
    'method'=>"POST",
