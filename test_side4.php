            ...
            <div class="col-md-2 col-sm-4 sidebar1">
               <!--  <div class="logo">
                ...
                <div class="left-navigation">
                    <ul class="list">
                        <h5><strong>UNAPPROVED FROMS</strong></h5>
                        <li><a href="approved_vs_resubmitted_form.php">Unapproved & Resubmitted Site Inductions Forms</a>
                        </li>
                        <li><a href="">Unapproved & Resubmitted Permits to Work </a>
                        </li>
