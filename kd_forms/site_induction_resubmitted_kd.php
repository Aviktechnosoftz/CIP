		...
		<form  name="site_form" method="POST" enctype="multipart/form-data" class="well form-horizontal well_class">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-3">						              
					        <label class="checkbox-inline" style="float: right;padding-right: 5px;">
						    	...
						    	<div style="margin-top: 6px;margin-left: 6px;width: 44px;height: 25px;"><label id="label_txt"> </label></div>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							...
							<input type="Number"  class="form-control form-control-left-radius" value="<? echo $test->induction_card_no; ?>" readonly>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
							...
							<img class="preview1" id="preview0" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  onerror="onerrorfun()"/>
	    			...
	    			<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview2" id="preview1" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
						 <span class="glyphicon glyphicon-eye-open" id="viewer1" style="" ></span>
				...
				<div class="form-group">
					<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview3" id="preview2" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer2" style="display:none" ></span>
	    			...
	    			<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview4" id="preview3" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer3" style="display:none" ></span>
				...
				<div class="form-group">
					<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview5" id="preview4" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
				               						 <span class="glyphicon glyphicon-eye-open" id="viewer4" style="display:none" ></span>
					...
					<div class="col-sm-6">
						...
						<img class="preview6" id="preview5" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer5" style="display:none" ></span>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
							<img class="preview7" id="preview6" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
													 <span class="glyphicon glyphicon-eye-open" id="viewer6" style="display:none" ></span>
					...
					<img class="preview8" id="preview7" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
				               						 <span class="glyphicon glyphicon-eye-open" id="viewer7" style="display:none" ></span>
				...
				<div class="form-group">
					<div class="col-sm-6">
						...
						<img class="preview9" id="preview8" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer8" style="display:none" ></span>
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
							<img class="preview10" id="preview9" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
													 <span class="glyphicon glyphicon-eye-open" id="viewer9" style="display:none" ></span>
				...
				<div class="form-group">
					<div class="col-sm-6">
						...
						<img class="preview11" id="preview10" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer10" style="display:none" ></span>
					...
					<div class="col-sm-6">
						...
						<img class="preview12" id="preview11" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer11" style="display:none" ></span>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						...
						<img class="preview13" id="preview12" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer12" style="display:none" ></span>
					...
					<div class="col-sm-6">
						...
						<img class="preview14" id="preview13" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  />
												 <span class="glyphicon glyphicon-eye-open" id="viewer13" style="display:none" ></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">								
							<label style="display: block">Rejection Comments:</label>
							<textarea  class="comment_section"  rows="5" id="comment_reject" name="comment_post" readonly><?=$test->comments  ?></textarea>
