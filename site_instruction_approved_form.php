...
if(isset($_REQUEST['send_email']))
{
  ...
  $response = file_get_contents("https://cipropertyapp.com/pdf_forms/pdf/site_ns_pdf.php?approved_form=".$_REQUEST['main_id']."");
$get_attachment= $conn->query("select a.attachments,a.emp_id,c.company_name,c.Tread,b.empid FROM tbl_induction_register b INNER JOIN tbl_instruction a ON a.emp_id = b.empid INNER JOIN tbl_employer c ON b.empid = c.id where a.id='".$_REQUEST['main_id']."'  group by b.empid")->fetch_object();
...
$doc_array=array();
$pdf_url="https://cipropertyapp.com/pdf_forms/pdf/pdf_download/site_ins_".$_REQUEST['main_id'].".pdf";
...
// print_r($doc_array);
  ...
  $to=$_REQUEST['other_email'];
     $Sub = "Site Instruction PDF Request is Here";
       ...
       $msg = "<html> 
          ...
          Site Instruction form Requested is Here...<br/><br/>
          ...
          Send from Mobile app <br/>   </body> 
            ...
            $data = array('to' => $to, 'msg' => $msg,'pdf_link' =>$doc_array,'trade' =>$get_attachment->Tread,'project_name' =>$_SESSION['project_name'],'number' => $_REQUEST['main_id'], 'subject' => $subject);
        ...
        <div class="col-md-12 zeropadding">
           <div class="alert alert-info">Instructions to be detailed with reference to attachments as necessary</div>
            ...
            <div class="input-group col-md-12">           
                <textarea class="form-control instruction_area" id="comment" style="-webkit-border-radius: 15px !important;-moz-border-radius: 15px !important;border-radius: 15px !important;border: none;font-size: 12px;resize: none" rows="10" name="instruction"  readonly> <? echo $main_query->instructions ?>  </textarea>
    ...
    <div class="modal-dialog">
      <div class="modal-content">              
        <div class="modal-body">
          ...
          <a class="help-button  downloadupaddinvoice " id="onerrorm1"  href="" download >Download </a>
