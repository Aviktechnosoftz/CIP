...
<!-- <div class="Main_Form" style="border: 1px solid grey;
 ...
 <table style='width: 70%;border: 1px solid rgba(128, 128, 128, 0.57);'>
           <div class="Form_name" style="background-color: #f5f5f5;"> <span style="font-size:3vh;text-align:left;line-height:2;color: #DF5430;font-family: Helvetica_Nue;font-weight: 200">Approved Site Induction Form</span>
			</div>
...
<div class="Main_Form2">
  <div class="col-md-12">	
	<form  name="site_form" method="POST" enctype="multipart/form-data" class="well form-horizontal well_class">
		<fieldset>
			<div class="row">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
								...
								<input type="text"  class="form-control form-control-left-radius" name="empe_name" id="given_name" value="<? echo $test->given_name; ?>">
								<script>
					...
					<div class="col-sm-6">
								...
								<input type="text" class="form-control form-control-left-radius" name="empe_surname" id= "surname" value="<? echo $test->surname; ?>">
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="date"  class="form-control form-control-left-radius" name="empe_dob"  value="<? echo $test->DOB; ?>" > 
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-3">						              
				        ...
				        <script>
				        	...
				        	$( document ).ready(function() {
				        		$("#preview"+"<? echo $row->image_id?>").click(function() {
				        			  
				        			$('.imagepreview').attr("src","https://cipropertyapp.com/API/Uploads/"+"<? echo $row->image_url?>");
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="date" min="1997-01-01" name= "gcic_date" class="form-control form-control-left-radius" value="<? echo $test->gcic_issue_date ?>" required>
					</div>
				</div>
			</div>
				...
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					...
	    					<input type="file" name="photo[]" id="Img1" class="hidden" value="ok"> 
	    					<label for="Img1" class="btn btn-primary btn-sm">Upload New File</label><br>      						
      						...
      						<img class="preview0" id="preview0" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(1)" />
				                <input type="file" name="photo[]" id="file_0" 
				                onchange="document.getElementById('preview0').src = window.URL.createObjectURL(this.files[0])" required><br>
								<label>General Construction Induction Card Back:</label>
						</p>
	    			</div>
	    			<div class="col-sm-6">
	    				<p style="text-align: center;">
	    					 <img class="preview1" id="preview1" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(2)" />
				                <input type="file" name="photo[]" id="file_2" 
				                onchange="document.getElementById('preview1').src = window.URL.createObjectURL(this.files[0])" required><br>
								<label>General Construction Induction Card Back:</label>
						</p>
					</div>
				</div>
	    	...
	    	<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					<img class="preview2" id="preview2" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(3)" />
				                <input type="file" name="photo[]" id="file_3" 
				                onchange="document.getElementById('preview2').src = window.URL.createObjectURL(this.files[0])" required><br>
								<label> Upload Driver License Front:</label>
						</p>
					</div>
    				<div class="col-sm-6">
	    				<p style="text-align: center;">
	    					<img class="preview3" id="preview3" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(4)" />
				                <input type="file" name="photo[]" id="file_4" 
				                onchange="document.getElementById('preview3').src = window.URL.createObjectURL(this.files[0])" required><br>
	    	...
	    	<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					<img class="preview4" id="preview4" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(5)" />
				                <input type="file" name="photo[]" id="file_5" 
				                onchange="document.getElementById('preview4').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
					<div class="col-sm-6">
	    				<p style="text-align: center;">
	    					<img class="preview5" id="preview5" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(6)" />
				                <input type="file" name="photo[]" id="file_6" 
				                onchange="document.getElementById('preview5').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
				</div>
	    	...
	    	<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">	    					
    						<img class="preview6" id="preview6" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(7)" />
				                <input type="file" name="photo[]" id="file_7" 
				                onchange="document.getElementById('preview6').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
					<div class="col-sm-6">
    					<p style="text-align: center;">
    					<img class="preview7" id="preview7" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(8)" />
				                <input type="file" name="photo[]" id="file_8" 
				                onchange="document.getElementById('preview7').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					<img class="preview8" id="preview8" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(9)" />
				                <input type="file" name="photo[]" id="file_9" 
				                onchange="document.getElementById('preview8').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
					<div class="col-sm-6">
	    				<p style="text-align: center;">
    						<img class="preview9" id="preview9" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(10)" />
				                <input type="file" name="photo[]" id="file_10" 
				                onchange="document.getElementById('preview9').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					<img class="preview10" id="preview10" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(11)" />
				                <input type="file" name="photo[]" id="file_11" 
				                onchange="document.getElementById('preview10').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
					<div class="col-sm-6">
    					<p style="text-align: center;">
	    					<img class="preview11" id="preview11" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(12)" />
				                <input type="file" name="photo[]" id="file_12" 
				                onchange="document.getElementById('preview11').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
	    					<img class="preview12" id="preview12" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(13)" />
				                <input type="file" name="photo[]" id="file_13" 
				                onchange="document.getElementById('preview12').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
					<div class="col-sm-6">
	    				<p style="text-align: center;">
	    					<img class="preview13" id="preview13" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(14)" />
				                <input type="file" name="photo[]" id="file_14" 
				                onchange="document.getElementById('preview13').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
						</p>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-6">				              
						...
						<input type="checkbox" class="checkbox_all faChkSqr" id="select_all"><div style="margin-top: 6px;width: 80px;height: 25px;text-align: right;">Select All</div>
			            </label>		          	
      				</div>
  				</div>
			</div>
				...
				<div class="form-group">
					<div class="col-md-12 rightpadding">
						...
						<div class="col-sm-6">
							...
							<div class="chkbox">							        
					            <input type="checkbox"  name="check_test[]" class="checkbox" <? echo ($topic_check->nduction_topic_27 == 1 ? 'checked' : ''); ?> >
					...
					<div class="form-group">
						<div class="col-md-12 rightpadding">
							...
							<!-- <div class="col-sm-6">
								...
								<div class="col-sm-10 chkcontent">
									<p>Information provided under Item 1. Addition Inductions</p>
								</div>
								<div class="chkbox"> -->
 ...
 -->
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<div class="col-sm-12" style="-webkit-border-radius: 15px;-moz-border-radius: 15px;	border-radius: 15px;background: #e4e4e4;">
								<p class="h5" style="text-align: left;font-weight: 100;">I <input type="text" style="border: 0;text-align: center;background: #e4e4e4;" value="<? echo $declaration->edit_certifiy ?>" readonly>&nbsp;<span style="float: right;color: #272727;"> certify the following:</span> </p>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
						<div style="-webkit-border-radius: 50px;-moz-border-radius: 50px;border-radius: 50px;background: #d3d3d3;height: 50px">
						 <div style="width: 50%; float: left;">
						 	<p class="h5" style="text-align: center;vertical-align: middle;">Declaration Date<br><? echo $declaration->todays_date?></p>
						</div>
						  <div style="-webkit-border-radius: 50px;-moz-border-radius: 50px;border-radius: 50px;background:url('<?="API/Uploads/".$declaration->your_signature ?>') center top no-repeat rgb(255, 255, 255);height: 50px;width: 50%;float: right;" name="sign_div" id= "sign_div">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">								
						<label>Induction Number</label>
								<input type="text" id= "induction_id"  class="form-control form-control-left-radius" value="<? $value= str_pad($test->inducted_by, 4, '0', STR_PAD_LEFT); echo $value; ?>" readonly>

						</div>
						<div class="col-sm-6">						
								<label>Name</label>
								<input type="text" id= "name_induction" class="form-control form-control-left-radius" readonly value=" <?echo $approval_select->given_name." ".$approval_select->surname ?>">
					...
					<div class="form-group">
						<div class="col-sm-6">
							<div class="col-sm-6 col-sm-offset-3">								
								<input type="submit" class="btn btn-primary form_submit_button" id= "submit_back" value="Back To Approved Forms"  name="set" />
							</div>
						</div>	
						<div class="col-sm-6">
							<div class="col-sm-6 col-sm-offset-3">	
								<input type="submit" class="btn btn-primary form_submit_button" id= "submit" value="Update Changes"  name="update"  data-complete-text="Loading Completed" autocomplete="off" />
