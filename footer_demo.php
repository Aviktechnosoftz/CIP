...
<span style="
    ...
    margin: 0px;
    padding-top: 0;
    padding-left: 13vw;    padding-top: 2vh;
    position: absolute;font-family: 'Avenirnext';"><label class="bottom_text" style="font-family: 'Avenirnext';">Date: &nbsp <?=date("d M Y ") ?></label></span>
