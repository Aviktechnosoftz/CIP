...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="control-label rightpadding"><span class="form-name">Site Induction Form&nbsp; </span></label>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="text" placeholder="Enter First Name Here.." class="form-control form-control-left-radius"  readonly>
					</div>								
				</div>
			</div>
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="text" placeholder="Enter Project Number Here.." class="form-control form-control-left-radius"  readonly>
					</div>
				</div>	
			</div>
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						<label>DATE</label>
						<input type="text" class="form-control form-control-left-radius" readonly>
					</div>
				</div>	
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="text" placeholder="Contact Person.." id="emp_contact" class="form-control form-control-left-radius" readonly>
					</div>
				</div>
			</div>
			<div class="row">
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader"  onclick="$('#file_1').click()" >
								 ...
								 <img class="preview1" id="preview1" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"/>
								 </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader2"  onclick="$('#file_2').click()" >
								 <img class="preview2" id="preview2" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(2)" />
							</div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader3"  onclick="$('#file_3').click()" >
								 ...
								 <img class="preview3" id="preview3" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(3)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<img class="preview4" id="preview4" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(4)" />
				                </div>
								<input type="file" name="photo[]" id="file_4" 
				                onchange="document.getElementById('preview4').src = window.URL.createObjectURL(this.files[0])" required><br>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader5"  onclick="$('#file_5').click()" >
								<img class="preview5" id="preview5" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(5)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader6"  onclick="$('#file_6').click()" >
								<img class="preview6" id="preview6" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(6)" />
				                </div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader7"  onclick="$('#file_7').click()" >
								<img class="preview7" id="preview7" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(7)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader8"  onclick="$('#file_8').click()" >
								<img class="preview8" id="preview8" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(8)" />
				                </div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader9"  onclick="$('#file_9').click()" >
								<img class="preview9" id="preview9" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(9)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader10"  onclick="$('#file_10').click()" >
								<img class="preview10" id="preview10" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(10)" />
									</div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader11"  onclick="$('#file_11').click()" >
								<img class="preview11" id="preview11" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(11)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader12"  onclick="$('#file_12').click()" >
								<img class="preview12" id="preview12" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(12)" />
				                </div>
					...
					<div class="form-group">
						<div class="col-sm-6">
							...
							<div id="uploader13"  onclick="$('#file_13').click()" >
								<img class="preview13" id="preview13" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(13)" />
				                </div>
						...
						<div class="col-sm-6">
							...
							<div id="uploader14"  onclick="$('#file_14').click()" >
								<img class="preview14" id="preview14" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onclick="get_image(14)" />
				                </div>
								<input type="file" name="photo[]" id="file_14" 
				                onchange="document.getElementById('preview14').src = window.URL.createObjectURL(this.files[0])"><br>
								<label> Upload Competency/ Certificates:</label>
							</div>
							</p>
						</div>
					...
					<div class="form-group">
						...
						<div style="-webkit-border-radius: 50px;-moz-border-radius: 50px;border-radius: 50px;background: #d3d3d3;height: 155px">
						 <div style="width: 50%; float: left;">
						 	<p class="h5" style="text-align: center;vertical-align: middle;">Today's Date<br></p>
						</div>
...
#uploader2:hover{color:#999;}
#file_2{display:none;}

#uploader3:hover{color:#999;}
#file_3{display:none;}

#uploader4:hover{color:#999;}
#file_4{display:none;}

#uploader5:hover{color:#999;}
#file_5{display:none;}

#uploader6:hover{color:#999;}
#file_6{display:none;}

#uploader7:hover{color:#999;}
#file_7{display:none;}

#uploader8:hover{color:#999;}
#file_8{display:none;}

#uploader9:hover{color:#999;}
#file_9{display:none;}

#uploader10:hover{color:#999;}
#file_10{display:none;}

#uploader11:hover{color:#999;}
#file_11{display:none;}

#uploader12:hover{color:#999;}
#file_12{display:none;}

#uploader13:hover{color:#999;}
#file_13{display:none;}

#uploader14:hover{color:#999;}
#file_14{display:none;}
