...
$obj4=$conn->query("Select * FROM tbl_employer where is_deleted=0 AND project_id=".$_SESSION['admin']."");
...
<div class="Main_Form" style="border: 1px solid grey;
 ...
 <table style='width: 70%;border: 1px solid rgba(128, 128, 128, 0.57);'>
          <div class="Form_name" style="background-color: #f5f5f5;"> <span style="font-size:3vh;text-align:left;line-height:2;color: #DF5430;font-family: Helvetica_Nue;font-weight: 200">Site Induction Form</span>
			</div>
					...
					<div class="col-sm-12">
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<select style="height: 34px;display: block;width: 100%;padding: 6px 12px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #fff;background-image: none;border: 1px solid #ccc;border-radius: 20vh;" id="select" onchange ="select2()" name="select_employer" required>
						...
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<input type="Number" placeholder="Enter Contact Number Here.." class="form-control input" name="empe_contact" required>
							</div>
							<div class="alert"></div>
						</div>
						<div class="row">
							...
							<div class="col-sm-6 form-group">
								...
								<select id="position" style="height: 34px;display: block;width: 100%;padding: 6px 12px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #fff;background-image: none;border: 1px solid #ccc;border-radius: 20vh;" name="empe_position" required>
						...
						<div class="row">
							...
							<div class="col-sm-4 form-group">
								...
								<input type="Number" placeholder="Enter Contact Number Here.." class="form-control input2" name="empe_emrg_number" required>
							</div>
						...
						<div class="row">
						    ...
						    <!-- <div class="col-md-2 col-sm-2">
	          				...
	          				<div class="col-sm-5 form-group">
								...
								<input  class="inline" type="Date" name="gcic_issue"  class="form-control" style=" border-radius: 20vh" min="1997-01-01" required>
							</div>
 ...
 -->
    ...
    font-family: Helvetica_Nue;">The personal information you have provided may be used for the purpose of contacting the person you have nominated in the event of an emergency. From time to time the information may be supplied to others such (as medical officers, ambulance officers) involved with the outcome of an emergency or medical situation. All disclosures will be subject to the provisions imposed by the Privacy Act 1988.</p>
						...
						<div class="row" style="border-bottom: 1px solid black">
							<div class="col-sm-12 form-group">
								<p class="h4" style="text-align: left;"><u>INDUCTION DECLARATION</u></p>
						...
						<div class="row" style="border: 1px solid black">
							<div class="col-sm-12 form-group">
								<p class="h5" style="text-align: left;font-weight: 100">I <input type="text" id="declaration_name" name="declaration_name" style="border: 0;text-align: center;"readonly>&nbsp certify the following: </p>
						...
						<div class="row" style="border-bottom: 1px solid black">
							...
							<div class="col-sm-3 form-group">
								<div id="sign_div" style="-webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3); height:180px; width:180px;background-repeat: no-repeat;margin-top:20px;background-position: center;" readonly>
								</div>
							...
							<div class="col-sm-3 form-group">
								<input type="text" style="border: 0; padding-top: 10px;text-align: center;" value="<? echo date("d/m/y"); ?>" readonly>
							...
							<div class="col-sm-12 form-group">
								...
								<input type="submit"  class="btn btn-info" id= "submit" value="Submit"  name="set"  data-complete-text="Loading Completed" autocomplete="off" style="width:20vw; height:4rem; color:white;background-color:#f47821 ;margin-top:3rem;outline: none;border-radius:6vh" />
