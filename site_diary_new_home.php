...
$get_project_name= $conn->query("Select * from tbl_project LEFT JOIN tbl_project_detail ON tbl_project_detail.project_id=tbl_project.id where tbl_project.id='".$_SESSION['admin']."'")->fetch_object();
 $decoded_date= base64_decode($_POST['date_selected']);
...
{
  $insert_diary_details= $conn->query("insert into tbl_site_diary set 
                   
                    project_id = '".$_SESSION['admin']."',
                    diary_date='".$_POST['diary_date']."',
                    lost_time='".$_POST['lost_time']."',
                    ohs_issue='".$_POST['ohs_issue']."',
                   contractual_issue='".$_POST['contractual_issue']."',
                   plant_hire='".$_POST['plant_hire']."',
                   work_undertaken='".$_POST[works_new]."',
                    general_comment='".$_POST['general_comments']."',
                    site_manager_id='".$get_site_manager->id."',
                    site_manager_date=DATE(NOW()),
                    site_foreman_name='".$_POST['site_foreman_name']."',
                    site_foreman_signature='".$_POST['sign_div_hide']."',
  ...
  if($insert_diary_details)
  {
     ...
     <script>
                  ...
                  alert("You Have Successfully Submitted Site Diary");
...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="col-md-12 control-label form-name">SITE DIARY FORM</label>
                ...
                <input name="city" id="date_show" placeholder="Date" class="form-control"  type="text" value="<? echo $get_query->today_date; ?>" readonly>
                            ...
                            <div class="form-group">
                                   <div style="padding-right: 10px"> 
                                    ...
                                    <textarea class="lost_time" rows="5" id="comment"  name="lost_time" ></textarea>
                                   </div> 
                            </div>
                            </div>
 ...
 <? } ?>
                            ...
                            <div class="form-group">
                                   <div style="padding-right: 10px"> 
                                    ...
                                    <textarea class="plant_hire" rows="5" id="comment" name="plant_hire" ></textarea>
                                   </div> 
                            </div>
                            </div>
                             ...
                             <div class="form-group">
                                    <div style="padding-right: 10px">
                                    <label class="col-md-12" id="text_area_label">WORKS UNDERTAKEN/ COMPLETED &nbsp <button style="outline: none" type="button" class="btn btn-default btn-sm show_hide">
          <span class="icon_work">+</span> Write Manually
        </button></label>
                                    <div  rows="30" id="comment" name="work_completed" style="text-align: left;height: 25.2vh;line-height: 22px;overflow-y: scroll;">
                                      <?
                            ...
                            <div class="form-group">
                                   <div style="padding-right: 10px"> 
                                    ...
                                    <textarea style="padding-left: 20px !important" class="works_new" rows="5" id="comment" name="works_new" ></textarea>
                                   </div> 
                            </div>
                            </div>
            ...
            <div class="input-group">
               ...
               <input type="hidden" name="farn_value" class="farn_val" value="<?=$temp2 ?>">
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea class="contract_issue" rows="5" id="comment"  name="contractual_issue" ></textarea>
  ...
  $str3= rtrim($str,','); echo $str3;
   ...
   <? } ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea class="general_comments" rows="5" id="comment"  name="general_comments" ></textarea>
      ...
      <div class="sig sigWrapper" style="height:auto;">
        <div class="typed"></div>
        <canvas class="sign-pad" id="sign-pad" width="300" height="100" style="background-color:white !important"></canvas>
...
<script>  var flag= 0;
      ...
      $("#btnSaveSign").click(function(e){
          ...
          if (canvas.toDataURL() != ""){console.log("having");}
...
$('.clearButton').click(function(){
        ...
        alert("Signature Cleared");
                            ...
                            <div class="form-group">
                               <label class="col-sm-6" id="check_label">Name</label>
                               <div class="col-sm-6"><input type="text" name="site_foreman_name" class="table_field2 site_foreman_name" style="margin-bottom: 5px"></div>
                               </div>
                            </div>
                            <div class="row">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-fill"  name="diary_submit" style="background-color: #E66F26;border:none;border-radius: 50px;width: 20%;margin-top: 25px;outline: none;">Submit</button>
...
<script>
  ...
  {
    // alert(work_flag);
    if($('.lost_time').val().trim()=="")
    {
      alert("Please Fill The Lost Time Details");
      return false;
    }

    else if(flag != 1)
    {
      alert("Signature Is Not Saved / Empty");
      return false;
    }
   
    else if($('.contract_issue').val().trim()=="")
    {
      alert("Please Fill Contractual Issue Details");
       return false;
    }

        else if($('.plant_hire').val().trim()=="")
    {
      alert("Please Fill Plant Hire Details");
       return false;
    }

     else if($('.works_new').val().trim()=="" && work_flag=='1')
    {
      alert("Please Fill Works Completed Details Manually");
       return false;
    }

    else if($('.general_comments').val().trim()=="")
    {
      alert("Please Fill General Comments");
       return false;
    }
    ...
    else if($('.pin').val().trim()!=<?echo $_SESSION['pin'] ?>)
    {
      alert("Please Enter Valid Pin");
       return false;
    }
      else if($('.site_foreman_name').val().trim() == "")
    {
      alert("Please Enter Site Foreman Name");
       return false;
    }
