...
from
   ...
   tbl_employer b
        ...
        inner join 
    tbl_employee c
        on a.employee_id = c.id where  date(a.created_date)='".$_GET['d']."' AND b.company_name='".$_GET['e']."'  AND a.is_approved='0' AND a.project_id= '".$_SESSION['admin']."' order by a.id desc ");
...
from
   ...
   tbl_employer b
        ...
        inner join 
    tbl_employee c
        on a.employee_id = c.id where a.is_approved='0' AND a.project_id=".$_SESSION['admin']." order by a.id desc");
}
?>
...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="control-label rightpadding"><span class="form-name">Saved Site Instruction Form&nbsp;<?// echo $project_name->project_name ?> </span></label>
        ...
        <tr style="background-color: #696969; color: white">
         ...
         <tbody style="" id='user'>
              ...
              <tr style="background-color: #f5f5f5; font-size: 15px"> 
                ...
                <td>
                  <form id="approved_form<?=$row->id?>" method="post" action="site_instruction_saved_form.php" >
