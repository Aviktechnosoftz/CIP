...
$(document).ready(function() {
    ...
    var $sidebar = $.extend($('#sidebar'), {
        ...
        switchContent: function(icon) {
            ...
            var current_data=$(icon).data('content');

             $('.list').each(function(){
                var each_data=$(this).parent().data('content');
                if(each_data == current_data)
                {
                    $(this).toggle();
                }
                else
            ...
            // $('.content[data-content="' + $(icon).data('content') + '"] > .list').show();
            // $(this '> .list').show();
...
// #sidebar > .contents > .contents > #contents_show