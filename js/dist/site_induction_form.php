...
$qry_declaration = $conn->query("insert into tbl_site_induction_declaration set 
                    ...
                    your_signature = '".$_POST['sign_div_hidden']."',
                    todays_date = now()");
				...
				<form  name="site_form"  method="POST" enctype="multipart/form-data">
					<div class="col-sm-12">
						...
						<div class="form-group">
							...
							<textarea placeholder="Enter Address Here.." rows="2" class="form-control" name="empe_add" id="person_address" onchange="return address_validate()" required"></textarea>
						...
						<div class="row">
							<div class="col-sm-6 form-group">
								...
								<input type="text" placeholder="Enter Occupation Here.." class="form-control" name="empe_occupation" required>
							</div>
							<div class="col-sm-6 form-group">
								<label>Your Position</label>
								<select style="height: 34px;display: block;width: 100%;padding: 6px 12px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #fff;background-image: none;border: 1px solid #ccc;border-radius: 4px;" name="empe_position" required>
						...
						<div class="row">
						    ...
						    <div class="col-md-2 col-sm-2">
	          				...
	          				<div class="col-sm-5 form-group">
								...
								<input  class="inline" type="Date" name="gcic_issue"  class="form-control" style=" border-radius: 4px" required>
							</div>
						...
						<div class="row" style="border-bottom: 1px solid black">
							...
							<div class="col-sm-6 form-group">
								...
								<input type="submit"  value="Submit" onclick="return address_validate()" name="set" style="width:20vw; height:4rem; color:black;margin-top:3rem;" />
							</div>
