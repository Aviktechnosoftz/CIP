<?
  ...
  $get_email_completed=$conn->query("select *,date_format(tbl_sm_weekly_action.created, '%y%m%d') as checkdate from tbl_sm_weekly_action where tbl_sm_weekly_action.checklist_udid = '".$udid."' and tbl_sm_weekly_action.action = '1' and (tbl_sm_weekly_action.actual_date != NULL or tbl_sm_weekly_action.actual_date != '' ) and (tbl_sm_weekly_action.action_complete != NULL or tbl_sm_weekly_action.action_complete != '') order by tbl_sm_weekly_action.id");
