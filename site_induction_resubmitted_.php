		...
		<form  name="site_form" method="POST" enctype="multipart/form-data" class="well form-horizontal well_class">
			...
			<div class="row">
					...
					<div class="col-sm-12" align="center">
						<label style="color: #fc3807;text-decoration: none">REJECTION COMMENTS-<br><? $arr=explode(",", $test->comments); foreach($arr as $value) { echo $value."<br>";}?></label>
				...
				<div class="row">
					...
					<div class="row">
						<div class="form-group">
							...
							<a href="#" data-toggle="modal" data-target="#bannerformmodal"> New Sign</a>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">								
							...
							<div  class="comment_section"  rows="5" id="comment_reject" name="comment_post" readonly><? $arr=explode(",", $test->comments); foreach($arr as $value) { echo $value."<br>";}?></div>
