<?php
include('environmental_plan.php');
error_reporting(0);
session_start();
...
<iframe src="https://docs.google.com/gview?url=http://cipropertyapp.com/Environmnet_plan_view.docx&embedded=true" style="    height: 81vh;
