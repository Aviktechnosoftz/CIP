            ...
            <div class="col-md-2 col-sm-4 sidebar1">
               <!--  <div class="logo">
                ...
                <div class="left-navigation">
                    <ul class="list">
                        <h5><strong>SITE ATTENDANCE</strong></h5>
                        <li>Site Attendance
                        <ul>
                        <li><a href="site_attendance_blank.php">New Site Attendance Form</a></li>
                        <li><a href="site_attendance_approved.php">Approved Site Attendance Form</a></li>
                        <li><a href="site_attendance_week.php">Site Attendance Register</a></li>
                        <!-- <li><a href="photo_gallery.php">Photo Works</a></li> -->
                        </ul>
                        </li>
