...
$your_date = $_REQUEST['attention_date'];
...
<div class="main_form_header">
  <div class="col-md-12" style="padding-top: 14px">
    <div class="col-md-6 main_title_container">
        ...
        <label class="col-md-12 control-label form-name">SITE DIARY ATTENTION FORM</label>
                ...
                <input name="city" id="date_show" placeholder="Date" class="form-control"  type="text" value="<? echo $get_query->today_date; ?>" readonly>
                            ...
                            <div class="form-group">
                                   <div style="padding-right: 10px"> 
                                    ...
                                    <textarea class="lost_time" rows="5" id="comment"  name="lost_time" ><?php if($get_diary->lost_time) echo trim($get_diary->lost_time);?></textarea>
                                   </div> 
                            </div>
                            </div>
            ...
            <div class="input-group">
               ...
               <input type="hidden" name="farn_value" class="farn_val" value="<?=$temp2 ?>">
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea class="contract_issue" rows="5" id="comment"  name="contractual_issue" ><?php if($get_diary->contractual_issue) echo trim($get_diary->contractual_issue);?></textarea>
  ...
  $str3= rtrim($str,','); echo $str3;
   ...
   <? } ?>
                            ...
                            <div class="form-group">
                                    ...
                                    <textarea class="general_comments" rows="5" id="comment"  name="general_comments" ><?php if($get_diary->general_comment) echo trim($get_diary->general_comment);?></textarea>
...
#signArea{
      ...
      .output>img,.output1>img,.output2>img,.output3>img,.output4>img,.output5>img,.output6>img,.output7>img,.output8>img,.output9>img,.output10>img,.output11>img,.output12>img,.output13>img,.output14>img
      {
        width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;
                            ...
                            <div class="form-group">
                               <label class="col-sm-6" id="check_label">Name</label>
                               <div class="col-sm-6"><input type="text" name="site_foreman_name" class="table_field2 site_foreman_name" style="margin-bottom: 5px" value="<?=$get_diary->site_foreman_name ?>"></div>
                               </div>
                            </div>
                            <div class="row">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-danger btn-fill"  name="diary_update" style="background-color: #E66F26;border:none;border-radius: 50px;width: 20%;margin-top: 25px;outline: none;">Approve Site Diary</button>
