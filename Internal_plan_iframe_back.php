...
<div class="modal fade bd-example" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="container">
      <div class="col-sm-12 col-md-12" style="height: 200px">
        <input type='file' onchange="readURL(this);" /> <div id="remove"></div>
    <img id="blah" src="image/image_upload2.png" style="padding: 20px 0 20px 0" />
     </div>
     <div class="col-sm-12 col-md-12" style="padding: 20px 0 20px 0" >
        OR
     </div>
    
     
        <div class="col-sm-12 col-md-12" style="">
       <select id="uploaded_select">
         <option>Hello</option>
       </select>
