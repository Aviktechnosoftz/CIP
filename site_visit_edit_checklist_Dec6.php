<?
  ...
  $get_action_required_content= $conn->query("select *,tbl_sm_report_action.row_id,tbl_sm_report_main.task_number as main_tasknumber,tbl_sm_report_action.emp_id as action_emp,tbl_sm_report_main.task_desc as main_taskdesc  FROM tbl_sm_report_action left join tbl_sm_report_main on (tbl_sm_report_main.id = tbl_sm_report_action.row_id) 
...
AND (tbl_sm_report_action.checklist_udid = '".$udid_edit."'  OR tbl_sm_report_action.checklist_udid is null )  )");
...
AND (tbl_sm_report_action.checklist_udid = '".$udid_edit."'  OR tbl_sm_report_action.checklist_udid is null )  )")->fetch_object();
?>
<header>
  <? include('header.php'); ?>
  ...
  <div class="modal fade" id="myModal2_action_<?= $row_action_required_detail->id ?>" role="dialog">
    <div class="modal-dialog modal-sm">
     ...
     <textarea id="task_name2"   rows="4" style="height: 70px; width: 100% ; border:none; outline: none;resize: none;background-color:#fff !important;border-radius: 20vh;    padding: 6px 12px;" readonly></textarea>
          ...
          <input type="text" class="form-control form-control-left-radius" name="" id="action_complete" style="height: 50px;" readonly> 
          </div>
