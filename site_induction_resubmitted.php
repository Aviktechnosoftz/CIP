			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
							...
							<input type="text" value="<? echo $test->address; ?>" name="empe_add" pattern="^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9 -/]+$" title="alphanumeric 5 to 250 chars" class="form-control form-control-left-radius" required />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input type="text"  class="form-control form-control-left-radius" name="empe_emrg_number" value="<? echo $test->emrg_contact_phone; ?>" required onkeypress="return event.charCode > 47 && event.charCode < 58;" pattern="^[0-9]*$" minlength="10" maxlength="12">
				...
				<!-- <div class="row">
					...
					<div class="row">
						<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="col-sm-6 col-sm-offset-3">								
									<input type="submit" class="btn btn-primary form_submit_button" id= "submit" value="Back"  name="back" />
							</div>	
							</div>
