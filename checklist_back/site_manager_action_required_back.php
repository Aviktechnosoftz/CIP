...
<div class="main_form_header_blue">
  <div style="height: 75%">
    <div class="col-md-12" style="padding-top: 14px;margin-left: 383px;">
      <div class="tab"><button class="tablinks" id="defaultOpen">Action Required(<?=$get_count->count?>)</button></div>
    </div>
  </div>
  <div style="height: 25%">
    <div class="col-sm-12 blue_table_head">
      ...
      <div class="col-sm-2"><span class="blue_table_label">Action</span></div>
    </div>
  </div>
</div>
...
<div class="Main_Form2_blue">
  <div class="col-md-12">
    <form class="well form-horizontal well_class" action=" " method="POST"  id="actionRequiredForm"  enctype="multipart/form-data" style="border: none;background: #393848;">
      <fieldset>
	            ...
	            <table id="mytable" class="table table-bordred" style=" background-color: #333240;color: #fff;">
              	<tbody>
	                <tr class="content_tr" id="mod_button" data-toggle="modal" data-target="#action_required_modal<?=$row_get_data->id?>">
                  	<td style="text-align: left;vertical-align: middle;"><?=$row_get_data->task_number?></td>    
                  	<td style="text-align: center;"><?=$row_get_data->task_desc?>
                    	<div id="span2" class="t r" style="text-align: center;">
        		...
        		<!--Pop Up for checklist editing-->
      				...
      				<div class="modal-dialog modal-sm">
        				<div class="modal-content" style="background: #393848 !important;">
          				...
          				<div class="modal-body">
            				...
            				<textarea id="task_name"   rows="4" style="height: 70px; width: 100% ; border:none; outline: none;resize: none;background-color:#fff !important;border-radius: 20vh; padding: 6px 12px;" readonly><?=$row_get_data->task_desc?></textarea>
            				<div class="" style="margin-top: 10px">
              				<label class="label_blue">Action Required</label>
              				<input type="text" class="form-control form-control-left-radius" name="" id="actionRequired" style="height: 50px;" value="<?if($row_get_data->checklist_action_comments == ''){echo $row_get_data->comments;}else{echo $row_get_data->checklist_action_comments;}?>" readonly> 
            				</div>
            				<div class="" style="margin-top: 10px">
                  		...
                  		<? }?> 
            				...
            				<textarea id="actualComment_<?=$row_get_data->id?>" rows="4" style="height: 70px; width: 100% ; border:none; outline: none;resize: none;background-color:#fff !important;border-radius: 20vh; padding: 6px 12px;" required></textarea>
            				<div class="" style="margin-top: 10px">
                    ...
                    <input type="hidden" id="empid" value="<?=$row_get_data->emp_id?>">
          				...
          				<div class="modal-footer" style="border-top: none;">
            				<button type="button" class="btn btn-default"  style="background-color:#f47821 ;margin-top:3rem;outline: none;border-radius:6vh;outline: none;border:none;color: #fff" onclick="update_action_required($('#tbl_id_<?=$row_get_data->aid?>').val(),$('#actualDate_<?=$row_get_data->id?>').val(),$('#actualComment_<?=$row_get_data->id?>').val(),$('#empid').val(),'<?=$row_get_data->final_row_id ?>','<?=$row_get_data->created_filled ?>')">Save</button>
