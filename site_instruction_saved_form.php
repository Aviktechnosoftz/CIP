...
$update_img= $conn->query("update tbl_instruction
  SET attachments='".rtrim($attachments,",")."' where id= '".$_POST['instruction_id']."'");
            ...
            $old_desc_hide =  explode(",",$_POST['old_desc_hide']);
   ...
   if($old_desc_hide[0] != "")
   {
   $new_array=array_merge($old_desc_hide,$_POST['desc']);
    }

    else
    {
      $new_array=$_POST['desc'];
    }
...
$str= implode($_POST['employee_new'],",");
  ...
  $str3="";
        ...
        $str4= rtrim($str3,',');
                  ...
                  $response = file_get_contents("https://cipropertyapp.com/pdf_forms/pdf/site_ns_pdf.php?approved_form=".$_POST['instruction_id']."");
$get_attachment= $conn->query("select a.attachments,a.emp_id,c.company_name,c.Tread,b.empid FROM tbl_induction_register b INNER JOIN tbl_instruction a ON a.emp_id = b.empid INNER JOIN tbl_employer c ON b.empid = c.id where a.id='".$_POST['instruction_id']."'  group by b.empid")->fetch_object();
...
$doc_array=array();
$pdf_url="https://cipropertyapp.com/pdf_forms/pdf/pdf_download/site_ins_".$_POST['instruction_id'].".pdf";
     ...
     $Sub = "New Site Instruction Form Submitted";
      ...
      $msg = "<html> 
          ...
          Send from Mobile app <br/>   </body> 
            ...
            $data = array('to' => $to, 'msg' => $msg,'pdf_link' =>$doc_array,'trade' =>$get_attachment->Tread,'project_name' =>$_SESSION['project_name'],'number' => $_POST['instruction_id'], 'subject' => $subject);
...
// print_r($img_arr[3]);
  ...
  $textArray = array(
    ...
    "2.7" => "<b class='bo' >2.7 &nbsp;Cleaning Up</b><br/> 
...
<div class="Main_Form2">
  <div class="col-md-12">
    ...
    <form class="well form-horizontal well_class" action="" method="post"  id="contact_form"  enctype="multipart/form-data" onsubmit="return validate()">
      ...
      <div class="form-group">
      <label class="col-md-12 control-label label-position">Site Instruction Number
              </label>
      ...
      <div class="form-group"> 
      <label class="col-md-12 control-label label-position">Subject
              </label>
        <div class="col-md-12 zeropadding">
            <div class="input-group">
              <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>            
        ...
        <div class="col-md-6 leftpadding">  
          ...
          <div class="col-md-12 zeropadding">
             <div class="input-group">
                ...
                <input  id="" placeholder="Date Goes Here" class="form-control"  type="text" name="date_today" value="<? echo date('Y-m-d') ?>" readonly>
            </div>
          </div>
      </div>
    </div>
   ...
   <!--    <div class="form-group"> 
      ...
      <div class="form-group">
        <div class="col-md-6 rightpadding">  
       <label class="col-md-12 control-label label-position">Telephone</label>
        <div class="col-md-12 zeropadding">
             <div class="input-group">
...
?>
      ...
      <div class="form-group"> 
       <div class="col-md-12 zeropadding"> 
        <label class="col-md-12 control-label label-position">Instructions</label>
        <div class="col-md-12 zeropadding">
           <div class="alert alert-info">Instructions to be detailed with reference to attachments as necessary</div>
           
            <div class="input-group col-md-12">           
                <textarea class="form-control instruction_area" id="comment" style="-webkit-border-radius: 15px !important;-moz-border-radius: 15px !important;border-radius: 15px !important;border: none;font-size: 12px;resize: none" rows="10" name="instruction"  > <? echo $main_query->instructions ?>  </textarea>
            ...
            <div class="col-md-9 col-md-offset-2 text-center">
              <center>
                <div class="input-group col-md-5">
                  <input type="Button" id="" name="" value="Edit Subcontract Conditions" data-toggle="modal" data-target="#termsModal" class="btn btn-warning form_submit_button"  >
                </div>
              </center>
    ...
    <div class="form-group"> 
     ...
     <!--    <label class="col-md-12 control-label label-position">Instruction</label> -->
        <div class="col-md-12 zeropadding">
          ...
          <div class="input-group col-md-12">
          <div style="padding-left: 10px;font-size: 13px;font-family: 'Avenirnext' !important;" id="title_sub">You Must Comply With The Following Subcontract Clauses
              </div>
...
.inputtolabel {
  ...
  top: -4px; 
    text-align:justify;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<b>2.1. Access and Scheduling</b><br/>
        <input type="checkbox" value="2.1.3"  class="clause inputtolabel">
        <span class=""><b>2.1.3.</b>The Contractor is entitled to require the Subcontractor at the Subcontractor's own cost from time to time to reschedule the performance of the whole or any part of the Subcontract Works including returning to the site on not less than 24 hours' notice to recommence the Subcontract Works. The Subcontractor is entitled to an extension of time if completion of the Subcontract Works is delayed by any such requirement. The Subcontractor acknowledges that any such requirement by the Contractor is not a breach of the Subcontract and the Contractor is not liable for any damages, costs and expenses suffered or incurred by the Subcontractor in complying with the requirement.</span>
      </span><hr/>
      
      

      <span class="spantoinput">
        &nbsp;&nbsp;&nbsp;&nbsp;<b>2.4. Directions</b><br/>
        <input type="checkbox" value="2.4.1"  class="clause inputtolabel"><b>2.4.1.</b>The Subcontractor must carry out the Subcontract Works in accordance with any directions given by the Contractor from time to time. If any direction by the Contractor is not given in writing, it must be confirmed in writing within 3 days of the direction.If the Contractor considers there is an emergency, it may give an oral direction, which must be acted on immediately by the Subcontractor and confirmed in writing by the Contractor within 24 hours.
      </span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="2.4.2"  class="clause inputtolabel"><b>2.4.2.</b>If the Subcontractor wishes to claim that a direction, although not stated to be a variation, involves a variation, it must lodge written notice with the Contractor to that effect within 3 days of receipt of the direction otherwise any subsequent claim that a variation is involved is barred absolutely.Without limiting this clause, the Contractor may concede in a particular instance or instances that a variation is involved without waiving the requirement for such written notice to be given in all other instances.</span><hr/>
      
      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="2.7"  class="clause inputtolabel"><b>2.7. Cleaning Up</b><br/>
      When on site, the Subcontractor must clean up and remove all rubbish from the site daily or, if so directed by the Contractor to designated areas on the site. Upon completion of the Subcontract Works, the Subcontractor must leave the site in a clean and tidy condition.If the Subcontractor fails within 24 hours from the receipt of a written direction by the Contractor to clean up or remove rubbish, the Contractor may (without being obliged to do so) arrange for the cleaning up, or, removal of the rubbish at the Subcontractors expense and the cost of doing so is a debt due and owing to the Contractor. The Contractor will advise the Subcontractor of any costs incurred under this clause.</span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.3" class="clause inputtolabel" ><b>5.3 Work by Others&nbsp;</b><br />If the Subcontract Works is dependent on or appreciably affected by the quality of any other work to be carried out or that has been carried out by the Contractor or any Separate Contractors ("other work"):</span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.3.1" class="clause inputtolabel"><b>5.3.1.</b>if the other work is defective, the Subcontractor must immediately notify the Contractor in writing so that the Contractor may arrange for the defects to remedied; and</span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.3.2" class="clause inputtolabel" ><b>5.3.2.</b>if the Subcontractor accepts the other work by proceeding with the execution of the Subcontract Works and the other work is subsequently found to be defective, then upon rectification of the other work by the Contractor (or any Separate Contractor), if directed by the Contractor the Subcontractor will re-execute that part of the Subcontract Works at no additional cost.</span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<b>5.7. Testing</b><br/><input type="checkbox" value="5.7.2"  class="clause inputtolabel">&nbsp;&nbsp;&nbsp;&nbsp;<b>5.7.2.</b>If the Contractor discovers materials or work which is not in accordance with the Subcontract, the Contractor may direct the Subcontractor to comply with the Subcontract and to:</span><hr/>
      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.7.3.1"  class="clause inputtolabel"><b>5.7.3.1.</b> remove materials from the site;</span><hr/>
      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.7.3.2"  class="clause inputtolabel"><b>5.7.3.2.</b> demolish work;</span><hr/>
      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.7.3.3"  class="clause  inputtolabel"><b>5.7.3.3.</b> reconstruct, replace, or correct the materials or work; or</span><hr/>
      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.7.3.4"  class="clause  inputtolabel"><b>5.7.3.4.</b> not deliver the materials or work to the site.</span><hr/>

      <span class="spantoinput">&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5.7.4"  class="clause  inputtolabel"><b>5.7.4.</b>The Subcontractor must comply with all such directions within the times specified by the Contractor and at no cost to the Contractor.</span><hr/>


      <span class="spantoinput">&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="checkbox" value="5.8"  class="clause  inputtolabel">
        <span><b>5.8. Cost of Rectification or Compliance</b><br />If the Subcontractor fails to comply with any direction from the Contractor given under the Subcontract and, in particular any direction under clauses 2.4, 2.7, 5.3, 5.5, 5.7 and 14.2 then, without giving further notice, the Contractor may arrange for compliance itself by performing the relevant work or by engaging others to do so and the cost of such performance will be a debt due and owing to the Contractor by the Subcontractor.</span>
      </span>
  </div>
            </div>
...
$("#limitedNumbSelect2").select2({
  ...
  $("#limitedNumbSelect3").select2({
        maximumSelectionLength: 15,
    placeholder: "Please Select Distribution List",
...
var parsedDate = $.datepicker.parseDate('yy-mm-dd', "<?php echo $main_query->req_date; ?>");
// $("#date").datepicker(
//     "setDate", new Date("")
// );
...
var textArray= {
  "2.1.3": "<b  >2.1.&nbsp; &nbsp;Access and Scheduling <br/>2.1.3.</b>&nbsp; &nbsp;  The Contractor is entitled to require the Subcontractor at the Subcontractor's own cost from time to time to reschedule the performance of the whole or any part of the Subcontract Works including returning to the site on not less than 24 hours' notice to recommence the Subcontract Works. The Subcontractor is entitled to an extension of time if completion of the Subcontract Works is delayed by any such requirement. The Subcontractor acknowledges that any such requirement by the Contractor is not a breach of the Subcontract and the Contractor is not liable for any damages, costs and expenses suffered or incurred by the Subcontractor in complying with the requirement.<hr/>",
    
    "2.4.1" : "<b class='bo' >2.4. &nbsp; Directions<br/>2.4.1&nbsp;</b>The Subcontractor must carry out the Subcontract Works in accordance with any directions given by the Contractor from time to time. If any direction by the Contractor is not given in writing, it must be confirmed in writing within 3 days of the direction.If the Contractor considers there is an emergency, it may give an oral direction, which must be acted on immediately by the Subcontractor and confirmed in writing by the Contractor within 24 hours.<hr/>",
    "2.4.2" : "<b class='bo'>2.4. &nbsp; Directions<br/>2.4.2&nbsp;</b>If the Subcontractor wishes to claim that a direction, although not stated to be a variation, involves a variation, it must lodge written notice with the Contractor to that effect within 3 days of receipt of the direction otherwise any subsequent claim that a variation is involved is barred absolutely.Without limiting this clause, the Contractor may concede in a particular instance or instances that a variation is involved without waiving the requirement for such written notice to be given in all other instances.<hr/>",
    ...
    "5.7.3.1" : " <b class='bo'>5.7.3.1 &nbsp;</b>remove materials from the site;<hr/>",
    "5.7.3.2" : " <b class='bo' >5.7.3.2 &nbsp;</b>demolish work;<hr/>",
    "5.7.3.3" :  "<b class='bo' >5.7.3.3 &nbsp;</b>reconstruct, replace, or correct the materials or work; or<hr/>",
    "5.7.3.4" : "<b class='bo' >5.7.3.4 &nbsp;</b> not deliver the materials or work to the site.<hr/>",
    "5.7.4" : "<b class='bo' >5.7.4 &nbsp;</b>The Subcontractor must comply with all such directions within the times specified by the Contractor and at no cost to the Contractor.<hr/>",
