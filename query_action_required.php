<?
  ...
  //echo $id." ".$date." ".$comment." ".$empid;die();
...
if($get_previous_checklist_update > 0)
{
  ...
  $update_checklist = $conn->query("update tbl_sm_weekly_action set action=1, updated=now(), actual_date='".$date."', action_complete='".$comment."',emp_id='".$empid."' where id=".$id);
