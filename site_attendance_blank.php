...
// WHERE inducted_by IS NOT NULL AND inducted_by != '' order by tbl_employee.given_name");
 $get_query=$conn->query(" select *,tbl_employer.company_name as name  from tbl_employer join  tbl_employee ON tbl_employee.employer_id=tbl_employer.id join tbl_induction_register ON tbl_employee.id= tbl_induction_register.id  where tbl_employer.project_id='".$_SESSION['admin']."' and tbl_employer.is_deleted = '0' AND tbl_induction_register.isapproved = 0   group by tbl_employer.id");
...
$building_images_0 = str_replace(' ','_', $path_parts0['filename']).'_'.time().'.'.$path_parts0['extension'];
}
if($_FILES['photo']['name'][1]!="")
  {
 $path_parts1 = pathinfo($_FILES['photo']['name'][1]);
$building_images_1 = str_replace(' ','_', $path_parts1['filename']).'_'.time().'.'.$path_parts1['extension'];
 }
 if($_FILES['photo']['name'][2]!="")
  {
 $path_parts2 = pathinfo($_FILES['photo']['name'][2]);
$building_images_2 = str_replace(' ','_', $path_parts2['filename']).'.'.$path_parts2['extension'];
 }
 if($_FILES['photo']['name'][3]!="")
  {
 $path_parts3 = pathinfo($_FILES['photo']['name'][3]);
$building_images_3 = str_replace(' ','_', $path_parts3['filename']).'_'.time().'.'.$path_parts3['extension'];
}
if($_FILES['photo']['name'][4]!="")
  {
 $path_parts4 = pathinfo($_FILES['photo']['name'][4]);
$building_images_4 = str_replace(' ','_', $path_parts4['filename']).'_'.time().'.'.$path_parts4['extension'];
}
if($_FILES['photo']['name'][5]!="")
  {
 $path_parts5 = pathinfo($_FILES['photo']['name'][5]);
$building_images_5 = str_replace(' ','_', $path_parts5['filename']).'_'.time().'.'.$path_parts5['extension'];
}
            ...
            <div class="form-group">
                    ...
                    <select name="subcontractor" class="form-control selectpicker" onchange="select_subcontractor()" id="subcontractor_name" style="border-bottom-right-radius: 10vh;
                      border-top-right-radius: 10vh" required>
                       ...
                       function select_subcontractor() {
                                     ...
                                     get_induction_subcontractor(strUser2);
                                     // alert(strUser2);
                                    $.ajax({
                                        type: "POST",
                                   ...
                                   function get_induction_subcontractor(employer)
                                    ...
                                    $.ajax({
                                       ...
                                       success: function(json) {
                                        console.log(json);
                                          ...
                                          var $el = $("#induction_subcontractor");
                                          $el.empty(); // remove old options
                                          $el.append($("<option></option>")
                                                  .attr("value", '').text('Please Select Subcontractor'));
              ...
              <div class="col-md-12 zeropadding">
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <div id="loading" style="float: right; color: red"></div>
                    <select name="induction_subcontractor" id="induction_subcontractor" class="form-control selectpicker"  id="subcontractor_name_2" style="border-bottom-right-radius: 10vh;
                      border-top-right-radius: 10vh" required>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12 zeropadding">
                  <div class="input-group">
                      ...
                      <input placeholder="No. of Workers" class="form-control" id="no_worker" name="no_worker"  type="number"  pattern="^([0-9]{1,})$" title="Enter only numeric values"  value="" autocomplete="off" readonly>
                  </div>
                  <script>
                        $(document).ready(function(){
...
2 men installing bollards to doorways D38 & D36" readonly></textarea>
      ...
      $('#desc1').attr('required', true);document.getElementById('viewer1').style.display = 'block';">
                  ...
                  <input name="desc1" placeholder="Image Description" class="simple_field  form-control" minlength="4" id="desc1"  type="text" value="" >
              </div>
              ...
              <div class="col-md-2 text-center" style="padding-left: 0px">
                  ...
                  <img class="preview" id="preview2" style=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block;"> -->
                         <span class="glyphicon glyphicon-eye-open" id="viewer2" style="left:55px;position:relative;top:25px;display:none"></span>
      ...
      $('#desc2').attr('required', true);document.getElementById('viewer2').style.display = 'block';">
                  ...
                  <input name="desc2" placeholder="Image Description" class="simple_field form-control" minlength="4" id="desc2"  type="text" value="" >
              </div>
              ...
              <div class="col-md-2 text-center" style="padding-left: 0px">
                  ...
                  <img class="preview" id="preview3"  style=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block; margin-left: -6vw;"> -->
                                           <span class="glyphicon glyphicon-eye-open" id="viewer3" style="left:55px;position:relative;top:25px;display:none"></span>
      ...
      $('#desc3').attr('required', true);document.getElementById('viewer3').style.display = 'block';">
                  ...
                  <input name="desc3" placeholder="Image Description" class="simple_field form-control" minlength="4" id="desc3"  type="text" value="" >
              </div>
                 ...
                 <img class="preview" id="preview4"  style=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block;"> -->
                                         <span class="glyphicon glyphicon-eye-open" id="viewer4" style="left:55px;position:relative;top:25px;display:none"></span>
      ...
      $('#desc4').attr('required', true); document.getElementById('viewer4').style.display = 'block';">
                 ...
                 <input name="desc4" placeholder="Image Description" class="simple_field form-control" minlength="4" id="desc4"  type="text" value="" >
                  </div>
              ...
              <div class="col-md-2 text-center" style="padding-left: 0px">
                 ...
                 <img class="preview" id="preview5"  style=" width: 120px;height: 130px;background-position: center center;background-size: cover; -webkit-box-shadow: 0 0 1px 1px rgba(0, 0, 0, .3);display: inline-block;"> -->
                                         <span class="glyphicon glyphicon-eye-open" id="viewer5" style="left:55px;position:relative;top:25px;display:none"></span>
      ...
      $('#desc5').attr('required', true);document.getElementById('viewer5').style.display = 'block';">
                 ...
                 <input name="desc5" placeholder="Image Description" class="simple_field form-control" minlength="4" id="desc5"  type="text" value="" >
                  </div>
      ...
      $('#desc6').attr('required', true); document.getElementById('viewer6').style.display = 'block';">
                 ...
                 <input name="desc6" placeholder="Image Description" class="simple_field form-control" minlength="4" id="desc6"  type="text" value="" >
                  </div>
               </div>   
