...
<a href="javascript:undo();" style="margin-right: 15px;" title="Undo"><i class="fa fa-undo" aria-hidden="true"></i></a>
 ...
 <!--  </div> -->
  ...
  <div class="col-sm-12 col-md-12" id="images" style="height: 10%; margin-top: 8px;margin-bottom: 8px;box-shadow: 0 0 5px 1px black;
    ...
    <div class="col-sm-2 col-md-2" style="float: right;padding: 10px;"><button class=" btn btn-info" id="b" type="button" style="background-color:#5bc0de !important;outline: none;border: none;" onclick="upload_map()">Save as Image</button></div>
...
<button class="btn btn-primary" data-toggle="modal" data-target=".bd-example">Large modal</button>
    ...
    <div class="modal-content">
       <div class="modal-header">
        ...
        <div class="modal-body">
          ...
          <div class="col-sm-2 col-md-2 selec_or">
             <h4 class="modal-title">OR</h4>
          </div>
    
     
        <div class="col-sm-4 col-md-4 selec">
           <select class="selec" id="uploaded_select">
             <option>Please Select Maps</option>
        ...
        <div class="modal-footer">
          <center>
           <button class=" btn btn-info" id="b" type="button" style="background-color:#5bc0de !important;outline: none;border: none;">Save as Image</button>
...
$("#remove").on('click', function() {
   $('#blah').attr('src', 'image/image_upload2.png').width(175)
                        ...
                        $('#file_input').val(''); 
                        $("#remove_icon").hide();
                         $('#uploaded_select').attr('disabled','false');
});
