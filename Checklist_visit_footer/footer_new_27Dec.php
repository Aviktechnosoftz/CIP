...
<div class="">
    ...
    padding-bottom: 6px;">
    <img class="checklistfooter" src="image/logo_foot_2.png" style="   width: 8.5vw;">
</span>
<span class="bottom_text footer_date" style="font-family: 'Avenirnext';">Issue Date: &nbsp <?=date("d M Y ") ?></span>
