...
<div id="wrap" class="colorskin-1">
  ...
  <header id="header">
    <div  class="container">
      <div class="four columns logo"><a href="index.php"><img src="images/logo.gif" id="img-logo"  title="avik" alt="avik"></a></div>
    ...
    <nav id="nav-wrap" class="nav-wrap2">
      <div class="container">
          ...
          <li class="current"><a class="selected" href="index.php" title="Home">Home <!--<span class="row-mn"></span>--></a>
            <!--<ul>
    ...
    <div id="layerslider-container-fw">
      <div id="layerslider" style="width: 100%; height: 436px; margin: 0px auto; ">
        ...
        <div class="ls-layer" style="slidedirection: top; slidedelay: 6000; durationin: 1500; durationout: 1500; delayout: 500;">
		 ...
		 <img src="images/mobile-apps.jpg" class="ls-bg" alt="">
		 ...
		 <!--<img src="images/slide1-p1.png" class="ls-s6" alt="" style="top: 48px; left: 68%;  slidedirection : fade; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1500;">-->
          ...
          <!--<h2 class="ls-s3" style="position: absolute; top:94px; left: 30px; slidedirection : top; slideoutdirection : top; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 1000;"><br>
            Responsive Template</h2>-->
			
          <h2 align="justify" class="ls-s3 l1-s1" style="position: absolute; top:194px; left: 30px; slidedirection : left; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 1000; color : #0f347a;">Smarter Choice, Superior Technology,Better iPhone/iPad Apps<br><br>IT Solutions in India Like Never Before</h2>
		  
		  
          <!--<h3 class="ls-s8" style="position: absolute; top:240px; left: 30px; width:460px; slidedirection : left; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 1400;">IT Solutions in India Like Never Before</h3>-->
		  
          <!--<a class="ls-s8" href="#" style="position: absolute; top:314px; left: 30px; slidedirection : bottom; slideoutdirection : bottom; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 1300;"></a>-->
		  
		   </div>
		   
        <div class="ls-layer" style="slidedirection: right; slidedelay: 5000; durationin: 1500; durationout: 1500;">
		
		 <img src="images/Information-Technology1.jpg" class="ls-bg" alt=""> 
		 ...
		 <!--<img src="images/slide1-p2.png" class="ls-s6" alt="" style="top: 30px; left: 68%;  slidedirection : bottom; slideoutdirection : bottom; durationin : 1500; durationout : 750; easingin : easeInOutQuint; easingout : easeInOutQuint; delayin : 800;">-->
          ...
          <h2 class="ls-s3" style="position: absolute; top:94px; left: 30px; slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 400; color : #0f347a;">Powering Up Innovative Software Solutions</h2>
		...
		<img src="images/it_photo1.jpg" class="ls-bg" alt=""> 
		...
		<!--<img src="images/cloud-slide1.png" class="ls-s6" alt="" style="top: 48px; left: 59%; slidedirection : right; slideoutdirection : top; durationin : 2000; durationout : 1700; easingin : easeOutExpo; delayin : 350;">
		 <img src="images/cloud-slide2.png" class="ls-s6"  alt="" style="top: 148px; left: 49%; slidedirection : right; slideoutdirection : top;  durationin : 2000; durationout : 1700; easingin : easeOutExpo; delayin : 1300;">
          ...
          <h2 class="ls-s3" style="position: absolute; top:94px; left: 30px; color:#fff; text-shadow:0px 1px 1px rgba(0,0,0,0.4); slidedirection : right; slideoutdirection : left; durationin : 3000; durationout : 750; easingin : easeInOutQuint; easingout : easeInBack; delayin : 1000;">Technically Sound & Professionally Perfect
            </h2>
...
Customization of open source CRM packages continues by adding new features, translating the application to a selected language, tracking and fixing bugs, integrating with other systems in network, the company suitably addresses client’s marketing and customer services.<br>
</p>
    ...
    <h4 class="subtitle">Disclaimer</h4>
     ...
     <div class="five columns">
      ...
      <div class="five columns contact-inf">
        ...
        <br />
        <p><strong> </strong>C-266, Basement</p>
