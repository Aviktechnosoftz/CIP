...
$_SESSION['name']=$_POST["txtName"]; $_SESSION['email']=$_POST["txtEmail"];$_SESSION['subject']=$_POST["txtSubject"];$_SESSION['message']=$_POST["txtText"];
 $errors= "<span style='color: #ff0000;'>You have entered invalid captcha Code.</span>";
}
...
function validateForm()
{
	...
	if (a==null || a=="")
	  ...
	  var k=document.forms["contactform"]["6_letters_code"].value;
	if (k==null || k=="")
	  {
...
<p>
C-266, Basement, Sector 63, Noida, India , PIN: 201301</ p>
<br />
...
<form action="thanku.php" method="post" id="frmContact" name="contactform" onSubmit="return validateForm()" >

<h5>Whats your Name?</h5>
<input name="txtName"  id="name" type="text" class="txbx" placeholder="Name" value="<?php  if(isset($_SESSION['name']))echo $_SESSION['name'];?>"/><br />
<h5>Whats your Email?</h5>
<input name="txtEmail" type="text" class="txbx" placeholder="Email" value="<?php  if(isset($_SESSION['email'])) echo $_SESSION['email'];?>" /><br />
<h5>Email Subject?</h5>
<input name="txtSubject"  id="subject" type="text" class="txbx" placeholder="Subject" value="<?php  if(isset($_SESSION['subject']))echo $_SESSION['subject'];?>"  /><br />
<div class="erabox">
<h5>Message to us</h5>
<textarea name="txtText"  id="message" tabindex="text" cols="" rows="" class="txbx era" ><?php  if(isset($_SESSION['message']))echo $_SESSION['message'];?></textarea><br />
<h5>
...
<input type="submit" class="sendbtn" value="Send Message" id="send" name="send" />
