...
<div class="Main_Form2">
  <div class="col-md-12">	
	<form  name="site_form" method="POST" enctype="multipart/form-data" class="well form-horizontal well_class" autocomplete="off">
		<fieldset>
			<div class="row">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						<label>DATE</label>
							<?$row['join_date'] = $test->created_date;
							$nice_date = date('d-m-Y', strtotime( $row['join_date'] ));?>
						<? $d=explode(' ', $nice_date);?>
						<input type="text" class="form-control form-control-left-radius" value="<?=date("d-m-Y", strtotime($d[0]));?>"  readonly>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						<p class="h4">EMPLOYER/ BUSINESS DETAILS</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
							...
							<input type="text" name="" id="address" value="<? echo $employer_name->address ?>"  class="form-control form-control-left-radius" readonly> 
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
							...
							<input type="text" name="empe_add" pattern="^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9 -/]+$" title="alphanumeric 5 to 250 chars" class="form-control form-control-left-radius" value="<? echo $test->address; ?>" required />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="text" id= "dob" class="form-control form-control-left-radius" name="empe_dob"  max="<? echo date('Y-m-d');?>" value="<? echo date_format(date_create($test->DOB),"d-m-Y"); ?>" > 
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input  class="form-control form-control-left-radius" name="empe_contact"  value="<? echo $test->contact_phone; ?>"  onblur="checkLength(this)"
						oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "12" required>
						<script type="text/javascript">
							function checkLength(el) {
  								if (el.value.length <= 10) {
    								alert("Contact Number must be having 10 numbers");
    								$(el).val('');
  								}
							}
						</script>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<select id="position" name="empe_position" style="height: 34px;display: block;width: 100%;padding: 6px 12px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #eee;background-image: none;border: 1px solid #eee;border-radius: 10vh;" name="empe_position" readonly >
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input type="Number"  class="form-control form-control-left-radius" name="empe_emrg_number" value="<? echo $test->emrg_contact_phone; ?>"  required onblur="theirContact(this)"
						oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" type = "number" maxlength = "12">
						<script type="text/javascript">
						function theirContact(aa)
						{
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="text"  name= "gcic_date" class="form-control form-control-left-radius" value="<? echo date_format(date_create($test->gcic_issue_date),"d-m-Y"); ?>" readonly>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input type="text" name= "itp_name"  class="form-control form-control-left-radius" value="<? echo $test->itp_name; ?>" readonly>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">								
						...
						<div class="col-sm-6">						
								<label>Name</label>
								<input type="text" id= "name_induction" class="form-control form-control-left-radius" readonly value=" <?echo $approval_select->given_name." ".$approval_select->surname ?>" readonly>
				...
				<div class="form-group">
					<div class="col-sm-6">								
						...
						<div class="col-sm-6">						
							...
							$nice_date = date('d-m-Y', strtotime( $row['join_date'] ));?>
						<? $d=explode(' ', $nice_date);?>
						<input type="text" class="form-control form-control-left-radius" value="<?echo $d[0]; ?>"  readonly>
...
<script>
	    					$(function() {
								    $("#surname").keyup(function(event) {
								        ...
								        var f_name= $("#given_name").val().trim();
										var l_name= $("#surname").val().trim();


			$.ajax({
							url: 'ajax_check_name.php',
...
preview0,.preview1,.preview2,.preview3,.preview4,.preview5,.preview6,.preview7,.preview8,.preview9,.preview10,.preview11,.preview12,.preview13,.preview14
{
