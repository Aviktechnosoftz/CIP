...
$get_main_maps_baclground=$conn->query("select * from tbl_maps_safety where project_id='".$_SESSION['admin']."' and is_activated='1'")->fetch_object();
// print_r($_SESSION);
// $home=true;



$Map_ID=$conn->query("select MAX(id)+1 as map_id from tbl_safety_layout_map where project_id='".$_SESSION['admin']."'")->fetch_object(); 
...
{
   $.ajax({
          url : "ajax_safety_plan_sel_refresh.php",
          type: "POST",
          data: {flag:true}, 
