...
<div id="canvas-container">
    ...
    <li style="margin-top:10px;">
          <button id="drawing-mode" class="btn btn-info drawing_btn" >Enter drawing mode</button>

           <button id="other_btn" class="btn btn-info" >Enter Straight Lines Mode</button>
...
$('#other_btn').text("Close Straight Lines Mode");
...
canvas.__eventListeners["mouse:down"] = [];
    $('#other').hide();
    $('#other_btn').text("Enter Straight Lines Mode");
