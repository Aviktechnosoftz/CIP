			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
							...
							<input type="text" name="empe_add" pattern="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{5,250})$" title="alphanumeric 5 to 250 chars" class="form-control form-control-left-radius" value="<? echo $test->address; ?>" required />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="date"  class="form-control form-control-left-radius" name="empe_dob"  max="<? echo date('Y-m-d');?>" value="<? echo date_format(date_create($test->DOB),"Y-m-d"); ?>" > 
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="date" min="1997-01-01" name= "gcic_date" class="form-control form-control-left-radius" value="<? echo date_format(date_create($test->gcic_issue_date),"Y-m-d"); ?>" readonly>
					</div>
				</div>
			</div>
