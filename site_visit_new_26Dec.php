  ...
  <div class="form-horizontal well_class_site_visit">
    ...
    <div class="form-group" style="text-align: center;margin-top: 80px;">
      <div class="col-sm-3" style="padding: 0px"  >
        ...
        <div class="col-sm-12">
        <label class="label_blue" style="margin-top: 10px;padding-left: 0px;">CIP Site Team</label>
      </div>
      </div>      
      <div class="col-sm-3" style="padding: 0px" >
        <div class="col-sm-12" style="border-right: 1px solid #ddd">
        ...
        <div class="col-sm-12">
        <label class="label_blue" style="margin-top: 10px;padding-left: 0px;">Review Calendar</label>
      </div>
    </div>
    <!-- </div>
    <div class="form-group"> -->
      <div class="col-sm-3" style="padding: 0px" >
        ...
        <div class="col-sm-12">
        <label class="label_blue" style="margin-top: 10px;padding-left: 0px;">Start Audit</label>
      </div>

    </div>
      <div class="col-sm-3" style="padding: 0px">
        <div class="col-sm-12">
          <button type="button"  class="bg4 " id= "submit_4" value=""  name="set"  data-complete-text="Loading Completed" autocomplete="off" onclick="myActionRequired()" >
            <span class="badge" style="background: red;padding: 4px 7px;font-size: 14px;margin-left: 20px; position: absolute;margin-top: -30px;color: #fff;">
              <? echo $act_count;?>
            </span>
          </button>
        </div>
        <div class="col-sm-12">
        <label class="label_blue" style="margin-top: 10px;padding-left: 0px;">My Action Item</label>
      </div>
    </div>     
  </div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">               
        <iframe src="mdate_visit.php" style="height: 550px" width="99.6%"  frameborder="0"></iframe>
      </div>
    </div>  
  </div>
</div>
...
<div class="modal fade" id="myModal_date_2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">               
        <iframe src="API/dataview_api.php?project=<?=$_SESSION['admin']?>" style="height: 80%" width="99.6%"  frameborder="0"></iframe>
      </div>
    </div>  
  </div>
</div>
