            ...
            <thead class="cf">
              ...
              <tr>
                <th  class="" width="5%">Sr. No.</th>
                 <th  class="" width="5%">Email Date</th>
                 <th  class="" width="5%" style="word-break: break-all;">Site <br/>Instruction No.</th>
                 <th  class="" width="5%">Date Issued</th>
                 <th  class="" width="10%">Trade</th>
                <th  class="" width="10%">Contractor</th>
                <th  class="" width="10%">Description</th>
                <th class="" width="5%">Variation Addition</th>
                <th class="" width="5%">Variation Deletion</th>
                <th class="" width="5%" style="word-break: break-all;">Consultant's <br/>Instruction Number</th>
                <th class="" width="5%" style="word-break: break-all;">Client's <br/>Instruction Number</th>
                <th class="" width="10%" style="word-break: break-all;">Is this a likely<br/>Client Variation Y/N</th>
                <th class="" width="20%">Comment</th>
        ...
        on a.employee_id = c.id where a.is_approved='1' AND a.project_id=".$_SESSION['admin']." order by a.id desc");
              ...
              <tr class="content">
               ...
               <td><?=$row->date?></td>
                ...
                <td > <div style="word-break: break-all;width: 170px"><?=$row->company_name?></div></td>
                <td style="word-break: break-all;"><?=$row->given_name." ".$row->surname?></td>
                
                <td style="word-break: break-all;"><?=$row->subject?></td>
                <td>N/A</td>
                <td>N/A</td>
                <td>N/A</td>
                <td>N/A</td>
                <td>No</td>
                 <td > <div style="word-break: break-all;width: 150px"><?=$comment?></div></td>
