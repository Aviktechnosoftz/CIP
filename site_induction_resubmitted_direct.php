...
// "&u=".$_SESSION['admin_user']."&p=".$_SESSION['admin_pass']."&ad=".$_SESSION['admin']."&ind=".$_SESSION['induction']."&pi=".$_SESSION['pin']."&p_name=".$_SESSION['project_name']."

$_SESSION['admin']=$_REQUEST['ad'];
$_SESSION['admin_user']=$_REQUEST['u'];
$_SESSION['admin_pass']=$_REQUEST['p'];
$_SESSION['induction']=$_REQUEST['ind'];
$_SESSION['pin']=$_REQUEST['pi'];
...
// die();
	...
	$insert_approve= $conn->query("Update `tbl_induction_register` set `inducted_by` = '".$ID."',`induction_card_no` = '".$_REQUEST['pin']."',`pincode` = '".$_REQUEST['pin_value']."' ,`isapproved` = '0'   ,`modified_date` = now() where `id`='".$s."'" ); 
...
<div class="Main_Form2">
  <div class="col-md-12">
    ...
    font-weight: 700 !important;font-style: normal !important;">REJECTION COMMENTS-<br><? $arr=explode(",", $test->comments);$resultstr = array(); foreach($arr as $value) {  $resultstr[] = $value ;} echo implode(",",$resultstr);?></label>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							...
							<input type="text" id="address" value="<? echo $employer_name->address ?>"  class="form-control form-control-left-radius" readonly> 
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
							...
							<!-- <textarea  rows="2" class="form-control form-control-left-radius" name="empe_add" pattern="(?!^[0-9]*$)(?!^[a-zA-Z]*$)^([a-zA-Z0-9]{5,250})$" title="alphanumeric 5 to 250 chars"  required> <? echo $test->address; ?></textarea> -->
							<input type="text" name="empe_add" pattern="^(?=.*[a-zA-Z])(?=.*[0-9])[a-zA-Z0-9 -/]+$" value="<? echo $test->address; ?>" title="alphanumeric 5 to 250 chars" class="form-control form-control-left-radius" required />
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="text"  class="form-control form-control-left-radius" id="dob" name="empe_dob"   value="<? echo date_format(date_create($test->DOB),"d-m-Y"); ?>" > 
					</div>
				</div>
			</div>
			<script type="text/javascript">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input  class="form-control form-control-left-radius" name="empe_contact"  value="<? echo $test->contact_phone; ?>" type = "text" onkeypress="return event.charCode > 47 && event.charCode < 58;" pattern="^[0-9]*$" minlength="10" maxlength="12" required>
				...
				<div class="form-group">
					<div class="col-sm-12">
							...
							<div class="col-sm-12" id= "position_other" hidden>
								...
								<input type="text" placeholder="Enter Position.." class="form-control form-control-left-radius" id= "position-other_text" name="" value="<?=$test->job_title ?>"  onchange="other_val()">
								<script>
									function other_val()
									{
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input type="text"  class="form-control form-control-left-radius" name="empe_emrg_number" value="<? echo $test->emrg_contact_phone; ?>" onkeypress="return event.charCode > 47 && event.charCode < 58;" pattern="^[0-9]*$" minlength="10" maxlength="12" required >
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input style="text-align: left;" type="text" min="1997-01-01" name= "gcic_date" class="form-control form-control-left-radius" value="<? echo date_format(date_create($test->gcic_issue_date),"d-m-Y"); ?>"    readonly>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
								...
								<input type="text" name="pin" minlength="4"  class="form-control form-control-left-radius" value="<? echo $test->induction_card_no; ?>" onchange="pin_generate()" minlength="4" id="pin_insert" required>
							

							<input type="hidden" name="pin_value" id= "pin_generation" value="<?$newstring = substr($test->induction_card_no, -4); echo $newstring?>">
							<script>
				...
				<div class="row">
					...
					<div class="row">
						<div class="form-group">
							...
							<div style="height: 120px;width: 200px;padding: 15px;margin-left: 50%;" >
								<div style="background:url('<?="API/Uploads/".$declaration->your_signature ?>') center top no-repeat rgb(255, 255, 255);height: 100%;width: 100%;text-align: center;background-size: 100%" name="sign_div" id= "sign_div""></div>
							</div>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<div class="col-sm-6 col-sm-offset-3">
									...
									<input type="submit" class="btn btn-primary form_submit_button" id= "submit" value="Resubmit Changes"  name="update"  data-complete-text="Loading Completed" autocomplete="off" />
								</div>
							</div>	
