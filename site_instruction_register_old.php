...
<div class="Main_Form_list">
      ...
      <div class="form-group">
           <div class="col-md-12" style="padding-left: 0px;padding-bottom: 5px;">
    		...
    		<!-- h1 class="text-center"> <span class="" style="font-size:3vh;text-align:left;line-height:2;color: #DF5430;font-family: Helvetica_Nue;font-weight: 200">Site Instruction Register <select id="view" onchange="select_view()" style="borrder-radius:10vh"> <option value="daily" selected="selected">Daily</option>
    ...
    $(document).ready(function() {
      ...
      if(a == 'Monthly'){
       ...
       if(a == 'Daily'){
        ...
        <div id="weekly" >
  			<form  method="POST" action="site_instruction_weekly.php">
...
$(function() {
 ...
 <div class="week-pick"></div>
                ...
                <div class="col-sm-12 form-group" style="padding: 0" >
                  ...
                  <div class="col-sm-6 form-group"> <input type="submit" name="selected_week_btn" value="View Report" class="btn btn-danger form_submit_button" id="submit" style="border-radius: 10vh"></div>
          </div>
        </form >
        </div>   
        <script>
...
<!-- Monthly Div -->
         <div id="monthly" >
        <form  method="POST" action="site_instruction_monthly.php">
        <input type="hidden"  name="start_date_week" id="form_start_date" value="" />
        <input type="hidden"  name="end_date_week" id="form_end_date" value="" />
        <div class="row">
        <div class="col-sm-6">
...
$(function() {
 ...
 <div class="week-picker"></div>
                ...
                <div class="col-sm-12 form-group" style="padding: 0" >
                  ...
                  <input type="submit" name="selected_week_btn" id="submit2" value="View Report" class="btn btn-danger form_submit_button" style="border-radius: 10vh"></div>
          </div>
        </form >
        <script>
...
<!-- Daily Div -->
         <div id="daily" >
        <form  method="POST" action="site_instruction_daily.php">
        <input type="hidden"  name="start_date_week" id="form_start_date" value="" />
        <input type="hidden"  name="end_date_week" id="form_end_date" value="" />
            <div class="row">
        <div class="col-sm-6">
...
$(function() {
 ...
 <div class="date-picker"></div>
                ...
                <input type="hidden" id="endDate3" placeholder="Week End Date"  name="end_date_week" class="form-control" value="" readonly>
                 <input type="submit" id="submit3" name="selected_week_btn" value="View Report" class="btn btn-danger form_submit_button" style=""></div>
          </div>
        </form >
        <script>
