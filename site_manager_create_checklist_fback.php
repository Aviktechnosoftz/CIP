...
<div class="main_form_header_blue" style="padding-top: 5px;height: 23%">
  <div class="row">
    ...
    echo date('n F Y', $yrdata); ?></span></div>
...
<div class="Main_Form2_blue" style="top: 44vh;max-height: 56.6%;">
  <div class="col-md-12" style="padding-left: 0;padding-right: 0">
    ...
    <? }?>
                    ...
                    <? } ?> 
                    <?if($check_exist_action > 0 ){ ?>
                       <div id="span2" class="t r" style=""><br><span class="glyphicon glyphicon-pencil" ></span>&nbsp<? 

if($get_action_status->action_required != ""){echo $get_action_status->action_required;$temp_comments= $get_action_status->action_required;}
                            ...
                            <div class="modal-dialog" style="height: 150px">  
                              ...
                              <div class="modal-content" style="border-radius: 25px;">
                                <div class="modal-header">
                                  ...
                                  <button type="button" class="btn btn-default" data-dismiss="modal" style="float: right; border: none;color: #10869D;" onclick="flip_content(<?=$row_main_detail->id ?>)">OK</button>
                                </div>
                                ...
                                <div class="modal-footer" style="height: 130px">
                                  <textarea id="action_comment_modal" class="action_modal_<?=$row_main_detail->id ?>" placeholder="Comment Here..." rows="4" style="height: 70px; width: 100% ; border:none; outline: none;resize: none;background-color:#fff !important" readonly></textarea>
                                </div>
                              </div>
                            </div>
                          </div>
...
<?}  else if($get_action_status->action =="3") {
  ...
  <? }?>
                          ...
                          <div class="col-sm-1"><span id="mod_btn" class="glyphicon glyphicon-edit glyphicon_gif" id="gif_edit" data-toggle="modal" data-target="#myModal_<?=$row_main_detail->id?>" data-current_act="<?=$get_action_status->action ?>" data-userid="<?php echo $row_main_detail->task_desc ?>" data-userid2="<?if($get_action_status->action_required != ""){echo $get_action_status->action_required;}else if($get_action_status->checklist_action_comments != "") echo $get_action_status->checklist_action_comments;else echo $row_main_detail->comments;?>"></span></div><?}?>
...
{
alert(act+task_id+main_comment+action_comment+action_required);
  $.ajax({
                        type: "POST",
