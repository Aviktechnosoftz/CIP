    ...
    <div class="form-group">
     <div class="col-sm-6 col-md-offset-6" style="padding-left: 0px;">
     	...
     	<form class="image_upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-3" style="padding-left: 0px;">
            <div id="uploader2"  onclick="$('#file_2').click()" style="margin-right: 55px; margin-left: -15px;">    
            ...
            <div class="col-sm-2" style="padding-left: 0px;">
              <div id="uploader3"  onclick="$('#file_3').click()" style="margin-left: -30px;margin-right: 35px;">
            ...
            <div class="col-sm-2" style="padding-left: 0px;">
                 <div id="uploader4"  onclick="$('#file_4').click()" style="margin-left: -14px;">
          ...
          <div class="col-sm-12">
            <div id="showUp" style="display: none">
                ...
                <div id="uploader5"  onclick="$('#file_5').click()" style="margin-left: 10px;">
            			<img id="upload_5"  width="70" height="70" />
            		</div>
                ...
                <div id="uploader6"  onclick="$('#file_6').click()" style="margin-left:40px;">
            			<img id="upload_6"  width="70" height="70" />
            		</div>
                ...
                <div id="uploader7"  onclick="$('#file_7').click()" style="margin-left: 65px;">
            			<img id="upload_7"  width="70" height="70" />
            		</div>
