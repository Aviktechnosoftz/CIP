...
// die();
$s_data = explode(",",$_POST['s_data']);
$m_data = explode(",",$_POST['m_data']);
$e_data = explode(",",$_POST['e_data']);
// echo "s_data1";
// echo "s_data2=".$s_data[1];
// die();
$query1= "select * from tbl_graph where Month(month)= '".$s_data[0]."' AND Year(month)= '".$s_data[1]."'";
				...
				$query2= "select * from tbl_graph where Month(month)= '".$m_data[0]."' AND Year(month)= '".$m_data[1]."'";
				...
				$query3= "select * from tbl_graph where Month(month)= '".$e_data[0]."' AND Year(month)= '".$e_data[1]."'";
