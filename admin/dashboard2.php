...
<div class="wrapper">
    ...
    font-size: 20px;color:#C8C8C8"></i>
                                ...
                                <div class="col-sm-3">
                                 ...
                                 <div style="width: 5vh;background:grey;">
                                    <i class="fa fa-times " aria-hidden="true" style="background-color: #424242;
    color: #ffffff;
    border-radius: 6vh;
    font-size: 19px;
    font-weight: 100;
    ...
    height: 25px;"></i> 
                        ...
                        <div class="col-sm-12" style="padding: 20px 0px 10px 0;    margin-left: 187px;">
                                   <p align="left" style="font-size: 3vh;color: #4E4E4E;">Technopark Phase 3</p>
                                   <p align="justify" style="font-size: 1.5vh;color: #767676">SU Campus, Technopark Phase 11105 Food Court with a seating capacity of axe is under construction at the Technopark Phase 3 Campus, Spread over MOO sq.M1 (including toilets), the Food coon Intends to offer a relaxed and Unhunied art-down meal experlence for hundreds of Individuals at a time. </p>
                                        </div>


                                </div>
                                <div class="col-sm-3">
                                    <div class="col-sm-12" style="border:0px solid #CDCDCD;height: 25vh;margin-top: 5vh;border-radius: 3vh;padding: 0px;height: inherit;width: 157px">
                                 <div style="width: 5vh;background:grey;">
                                    <i class="fa fa-times " aria-hidden="true" style="    background-color: #424242;
    color: #ffffff;
    border-radius: 6vh;
    ...
    height: 25px;"></i> 
                               ...
                               <div class="bs-example">
                                <div id="myCarousel2" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="images/project_slide2.png" alt="First Slide">

                                        </div>
                                        <div class="item">
                                            <img src="images/project_slide2.png" alt="Second Slide">
                                        </div>
                                        <div class="item">
                                            <img src="images/project_slide2.png" alt="Third Slide">
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-12" style="padding: 20px 0px 10px 0;    margin-left: 24px;">
                                   <p align="left" style="font-size: 3vh;color: #4E4E4E">KINFRA <br>Perth</p>
                                   <p align="justify" style="font-size: 1.5vh;color: #767676">Kerala Industries infrastructure development Corporation. complete world class ecosystem of work and life Is being structured at Technopark which will elevate it to International standards! </p>
                                        </div>
    ...
    height: 25px;"></i> 
                        ...
                        <div class="row" id="content_2">
                             ...
                             <div class="row nomargin" id="content_3">
                                    ...
                                    <div class="col-sm-6" >
                                        <div class="thumb" >
                                           <div class="col-sm-4"><img src="images/thumb_1.png" height="48px" width="48px" style="border-radius: 6vh"></div>
                                            <div class="col-sm-8" style="line-height: 50px;">Technopark Phase 3</div>
