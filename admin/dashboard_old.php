                          ...
                          <div class="col-sm-12" style="border:0px solid #CDCDCD;height: 25vh;margin-top: 5vh;border-radius: 3vh;padding: 0px;margin-right:3vh;height: inherit;/*width: 157px">
                            ...
                            <div class="bs-example">
                              <div id="myCarousel<?=$row_project_details->id ?>" class="carousel fade" data-ride="carousel">
                                ...
                                <div class="carousel-inner" onclick="redirect_homepage(<?= $row_project_details->project_id?>)" style="cursor: pointer;    border-radius: 16px;">
                                <? for($i=0;$i<=3;$i++){ 
                                    $j=$i+1;
                                    $image_col="image_".$j;
                                    if($row_project_details->$image_col !="")
                                ...
                                ?>
                                  <div class="item <?if(!$i) echo "active" ?>" style="">
									...
									<div class="cross-wrapper">
											...
											<img src="temp_uploads/<?=$row_project_details->$image_col?>" alt="First Slide" id="<?=$row_project_details->project_id ?>" class="img-rounded draggable back-img"
											onError="this.onerror=null;this.src='document.png';">
																				
										<div style="width: 5vh;background:grey;">
                                    <i title="Archieve" class="fa fa-times cross-img" aria-hidden="true" style="background-color: #424242; color: #ffffff; border-radius: 6vh;font-size: 19px; font-weight: 100;    position: absolute; z-index: 100; /*top: 15px;*/ padding-top: 3px; width: 25px;
    /*left: -10px;*/ -webkit-text-stroke: 2px #424242; height: 25px;cursor: pointer;" onclick="archieve_click()"></i> 
	
	<label for="submitbutton"><i class="fa fa-pencil-square-o" aria-hidden="true" id="edit_icon"></i></label>
                          ...
                          <form action="create_home_kd.php" method="post">
                            <div class="thumb" >
                              <div class="col-sm-4" style="padding-top: 0">
                                <img 
								src="<?if($row_project_details2->image_1!="") echo "temp_uploads/".$row_project_details2->image_1;                                 
