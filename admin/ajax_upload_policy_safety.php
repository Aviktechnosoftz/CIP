...
if ($_FILES["music"]["error"] == UPLOAD_ERR_OK)
{
	...
	$tmppath="../API/Uploads/"."Safety_Policy.".$extension;
    // now you have access to the file being uploaded
    //perform the upload operation.
    move_uploaded_file($_FILES['music']['tmp_name'],$tmppath);


    $update_safety=$conn->query("Update  tbl_policy set safety_policy = 'Safety_Policy.".$extension."' where id='1'");

echo "Safety_Policy.".$extension."";
}
?>