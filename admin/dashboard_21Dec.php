...
<html lang="en">
  ...
  <body>
    ...
    /*left: -10px;*/ -webkit-text-stroke: 2px #424242; height: 25px;cursor: pointer;" onclick="archieve_click(1)"></i> 
  
  <label for="submitbutton1"><i class="fa fa-pencil-square-o" aria-hidden="true" id="edit_icon"></i></label>
                          ...
                          <form action="create_home_kd.php" method="post">
                            <div class="thumb" >
                              <div class="col-sm-4" style="padding-top: 0">
                                ...
                                else echo "No Image";?>" height="48px" width="48px" style="border-radius: 6vh">
                              </div>
