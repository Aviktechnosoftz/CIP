...
error_reporting(0);
$get_project_details=$conn->query("select * from tbl_project_detail");
$get_project_details2=$conn->query("select * from tbl_project_detail");
...
<div class="wrapper">
            ...
            <ul class="nav">
             ...
             <li>
                    <a href="under_construction.php">
                        ...
                        <p id="cart-item" style="">Archived <span id="getarchived"></span></p>
                    </a>
                </li>
                <li>
                    <a href="under_construction.php">
                            ...
                            <div class="row nomargin" id="content_1">
                               <div class="col-sm-3">
                                ...
                                <? while($row_project_details= $get_project_details->fetch_object()){ ?>
										<?
										// =$row_project_details->project_id ?>
    ...
    height: 25px;"></i> 
                                ...
                                <div id="myCarousel<?=$row_project_details->id ?>" class="carousel fade" data-ride="carousel">
                                    ...
                                    <? for($i=0;$i<=3;$i++){ 
                                        ...
                                        <div class="item <?if(!$i) echo "active" ?> " >
											...
											<img src="temp_uploads/<?=$row_project_details->$image_col?>" alt="<?=$row_project_details->is-archieved ?>" class="img-rounded draggable alarchived" id="<?=$row_project_details->project_id ?>">
											
                                        </div>
											<p>
											<?php  
											// echo $row_project_details->project_id; 
											?>
											
											</p>
										<script>
										// $('#www').hover({
										// alert(this."<?=$row_project_details->project_id ?>")
                         ...
                         <div class="col-sm-12" style="padding: 20px 0px 10px 0; ">
                                   ...
                                   <p align="justify" style="font-size: 1.5vh;color: #767676"><?=$row_project_details->project_scope?></p>
...
$(document).ready(function() {
	...
	$("#cart-item").on('drop', function (e){
		...
		else if (isarchieved == 1 ) 
		{ 
			alert(" Already in Achived !");
		  	// document.getElementByID(aaaaa).innerhtml = source_id;

		}
	});
});
</script>
<style>.selectDisable { color: red;
width:500px; }
</style>

                       <div ><p style="width:200px;height:200px;background-color;gray"> </p></div>
