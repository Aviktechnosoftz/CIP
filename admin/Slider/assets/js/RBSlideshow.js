...
function assignCurrentSlide() {
	...
	$('#currentSlide >h3').text(caption.replace('***', '\n').split('##')[0]);
	$('#currentSlide >div').text(caption.replace('***','\n').split('##')[1]);
...
function assignNextPrevSlides() {
	...
	$('#nextSlide >h3').text(caption.replace('***','\n').split('##')[0]);
	$('#nextSlide >div').text(caption.replace('***','\n').split('##')[1]);

	index = indexPrevSlide;
	takeSource();
	$('#prevSlide').css('background-image', 'url(' + imageUrl + ')');
	caption.replace("***", "<br>");
	$('#prevSlide >h3').text(caption.replace('***','\n').split('##')[0]);
	$('#prevSlide >div').text(caption.replace('***','\n').split('##')[1]);
...
function animateToNext() {
	$('#slides').animate({'opacity': 0.4,'left': -100 + 'vw'}, durationAnimation);
