	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12" style="padding: 0">
				<div class="card">
				  <div class="header" id="header_hide" style="">
...
<div id="ajax_load" style="text-align:center;display:none"><img src="images/loading.gif" style=" width: 8%; height: 14%;position: absolute;top: 43%;left: 46%;"></div>
				  <!-- loading image end-->

  <div class="content" style="">
    <form class="pro_input" method="POST" id="form_hide" enctype="multipart/form-data">
...
<label >Phone No.</label><input class="form-control imp" data-val='1' type="number" id="Safety_manager_ph" name="Safety_manager_ph">
	        ...
	        <div class="col-sm-6"> 
	            ...
	            <div class="col-sm-6">
<label >Phone No.</label><input class="form-control imp" data-val='1' type="number" id="safety_represenative_ph" name="safety_representative_ph">
	            </div>
	            </div>
	             <div class="row">
	        <div class="col-sm-6"> 
...
<label >Phone No.</label><input class="form-control imp" data-val='1' type="number" id="contract_admin_ph" name="contract_admin_ph">
     ...
     <div class="col-sm-6 col-md-offset-6" style="padding-left: 0px;">
     	...
     	<form class="image_upload" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-3" style="padding-left: 0px;">
              <div id="uploader"  onclick="$('#file_1').click()" style="margin-right: 45px;">
            	<img id="upload_1"  width="70" height="70" onerror="$('#upload_1').attr('src','Document.png')"/></div>
            ...
            <div class="col-sm-3" style="padding-left: 0px;">
            <div id="uploader2"  onclick="$('#file_2').click()" style="margin-right: 55px; ">    
            <img id="upload_2"  width="70" height="70" onerror="$('#upload_2').attr('src','Document.png')"/></div>
            ...
            <div class="col-sm-3" style="padding-left: 0px;">
              <div id="uploader3"  onclick="$('#file_3').click()" style="margin-right: 35px;">
            <img id="upload_3"  width="70" height="70" onerror="$('#upload_3').attr('src','Document.png')"/></div>
            ...
            <div class="col-sm-3" style="padding-left: 0px;">
                 <div id="uploader4"  onclick="$('#file_4').click()" style="">
            <img id="upload_4"  width="70" height="70" onerror="$('#upload_4').attr('src','Document.png')"/></div>
           ...
           <!--  <div class="col-sm-2" style="padding-left: 0px;">
              <div id="btnShowUp"  onclick="$('#showUp').show()"  style=" font-size: 40px; margin-top: 7px;cursor: pointer;">
          ...
          <!-- <div class="col-sm-12">
            <div id="showUp" style="display: none">
            	<div class="col-sm-2" style="padding-left: 0px;">
                <div id="uploader5"  onclick="$('#file_5').click()" style="margin-left: 10px;">
            			<img id="upload_5"  width="70" height="70" onerror="$('#upload_5').attr('src','Document.png')"/>
            		</div>
            		<input type="file" id="file_5"
            			onchange="document.getElementById('upload_5').src = window.URL.createObjectURL(this.files[0]);progress_settings(this)" data-val='5'>
            			<label style="margin-left: 25px;"> Safety Policy</label>
            	</div> 
            	<div class="col-sm-2" style="padding-left: 0px;">
                <div id="uploader6"  onclick="$('#file_6').click()" style="margin-left:40px;">
            			<img id="upload_6"  width="70" height="70" onerror="$('#upload_6').attr('src','Document.png')"/>
            		</div>
            		<input type="file" id="file_6"
            			onchange="document.getElementById('upload_6').src = window.URL.createObjectURL(this.files[0]);progress_settings(this)" data-val='5'>
            			<label style="margin-left: 55px;">Quality Policy</label>
            	</div>  
            	<div class="col-sm-2" style="padding-left: 0px;">
                <div id="uploader7"  onclick="$('#file_7').click()" style="margin-left: 65px;">
            			<img id="upload_7"  width="70" height="70" onerror="$('#upload_7').attr('src','Document.png')"/>
            		</div>
            		<input type="file" id="file_7"
            			onchange="document.getElementById('upload_7').src = window.URL.createObjectURL(this.files[0]);progress_settings(this)" data-val='5'>
            			<label style="margin-left: 75px;">Environmental Policy </label>
            	</div>                                          
            </div>
    		</div> -->
    	</div>
    ...
    <div class="form-group">                            
        <div class="col-sm-12">
            ...
            <input type="button" value="Cover" id="cover_btn" />
...
{       
	var check_image=[];
	var default_array=[0,0,0,0,0,0,0];
	var token_image=0;
	for(i=0;i<=6;i++)
	{
		check_image.push($("input:file")[i].files.length);
	}
	// console.log(check_image);
 	if ( JSON.stringify(check_image) == JSON.stringify(default_array) ) {
 			token_image=0;
 	}
 	else
 	{
  ...
  if(token_image==0 || project_name_1.value=="" || project_number.value=="" || state_name_hidden.value=="" )
  {   
...
//onerror='+javascript:this.src="Document.png"+'
                    });
