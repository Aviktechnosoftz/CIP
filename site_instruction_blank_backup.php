       ...
       <div class="col-md-12 zeropadding"> 
        ...
        <div class="col-md-12 zeropadding">
          ...
          <div class="input-group col-md-12">
            ...
            <textarea class="form-control instruction_area" rows="20" id="comment" name="instruction" style="-webkit-border-radius: 15px !important;-moz-border-radius: 15px !important;border-radius: 15px !important; " required></textarea>
          ...
          <div class="col-md-12 zeropadding"> 
             <div class="col-sm-3" style="">
              <div id="uploader"  onclick="$('#file_1').click()" >
                <img id="upload_1"  width="70" height="70"  />
                </div>
      ...
      $('#desc1').attr('required', true);">
              ...
              <div class="col-sm-3 text-center">
               <div id="uploader2"  onclick="$('#file_2').click()" >
                <img id="upload_2"  width="70" height="70"  />
                </div>
      ...
      $('#desc2').attr('required', true);">
              <input name="desc2" placeholder="Image Description" class="simple_field form-control"  id="desc2"  type="text" value="" >
               ...
               <div class="col-sm-3 text-center">
                ...
                <img id="upload_3"  width="70" height="70"  />
                </div>
      ...
      $('#desc3').attr('required', true);">
              ...
              <div class="col-sm-3 text-right">
               <div id="uploader4"  onclick="$('#file_4').click()" >
                <img id="upload_4"  width="70" height="70" />
                </div>
...
<div class="modal fade" id="termsModal" tabindex="-1" role="dialog" aria-labelledby="Terms and conditions" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title">Subcontract Conditions</h3>
            </div>

            <div class="modal-body">
               <div style="text-align: justify;">
     <input type="checkbox" value="2.1.3"  class="clause" > <b>2.1.3.</b>The Contractor is entitled to require the Subcontractor at the Subcontractor’s own cost from time to time to reschedule the performance of the whole or any part of the Subcontract Works including returning to the site on not less than 24 hours’ notice to recommence the Subcontract Works. The Subcontractor is entitled to an extension of time if completion of the Subcontract Works is delayed by any such requirement. The Subcontractor acknowledges that any such requirement by the Contractor is not a breach of the Subcontract and the Contractor is not liable for any damages, costs and expenses suffered or incurred by the Subcontractor in complying with the requirement.<br/><br/>
    <input type="checkbox" value="2.4.1"  class="clause"><b>2.4.1.</b>     The Subcontractor must carry out the Subcontract Works in accordance with any directions given by the Contractor from time to time. If any direction by the Contractor is not given in writing, it must be confirmed in writing within 3 days of the direction.If the Contractor considers there is an emergency, it may give an oral direction, which must be acted on immediately by the Subcontractor and confirmed in writing by the Contractor within 24 hours.<br/><br/>
    <input type="checkbox" value="2.4.2"  class="clause"><b>2.4.2.</b>     If the Subcontractor wishes to claim that a direction, although not stated to be a variation, involves a variation, it must lodge written notice with the Contractor to that effect within 3 days of receipt of the direction otherwise any subsequent claim that a variation is involved is barred absolutely.Without limiting this clause, the Contractor may concede in a particular instance or instances that a variation is involved without waiving the requirement for such written notice to be given in all other instances.<br/><br/>
    <input type="checkbox" value="2.7"  class="clause"><b>2.7.&emsp;Cleaning Up</b>
    When on site, the Subcontractor must clean up and remove all rubbish from the site daily or, if so directed by the Contractor to designated areas on the site.  Upon completion of the Subcontract Works, the Subcontractor must leave the site in a clean and tidy condition.If the Subcontractor fails within 24 hours from the receipt of a written direction by the Contractor to clean up or remove rubbish, the Contractor may (without being obliged to do so) arrange for the cleaning up, or, removal of the rubbish at the Subcontractors expense and the cost of doing so is a debt due and owing to the Contractor.  The Contractor will advise the Subcontractor of any costs incurred under this clause.<br/><br/>
    <input type="checkbox" value="5.3" name="chkParent" id="parentChk" class="clause" onclick="pcCheck();"><b>5.3.&emsp;Work by Others</b>If the Subcontract Works is dependent on or appreciably affected by the quality of any other work to be carried out or that has been carried out by the Contractor or any Separate Contractors (“other work”):<br/><br/>
    &emsp;<input type="checkbox" value="5.3.1" name="ch[]" class="clause" onclick="pCheck();"><b>5.3.1.</b>if the other work is defective, the Subcontractor must immediately notify the Contractor in writing so that the Contractor may arrange for the defects to remedied; and<br/><br/>
    &emsp;<input type="checkbox" value="5.3.2" name="ch[]" class="clause" onclick="pCheck();"><b>5.3.2.</b>if the Subcontractor accepts the other work by proceeding with the execution of the Subcontract Works and the other work is subsequently found to be defective, then upon rectification of the other work by the Contractor (or any Separate Contractor), if directed by the Contractor the Subcontractor will re-execute that part of the Subcontract Works at no additional cost.<br/><br/>
    <input type="checkbox" value="5.7.2"  class="clause"><b>5.7.2.</b>     If the Contractor discovers materials or work which is not in accordance with the Subcontract, the Contractor may direct the Subcontractor to comply with the Subcontract and to:<br/><br/>
    <input type="checkbox" value="5.7.3.1"  class="clause"><b>5.7.3.1.</b> remove materials from the site;<br/><br/>
    <input type="checkbox" value="5.7.3.2"  class="clause"><b>5.7.3.2.</b> demolish work;<br/><br/>
    <input type="checkbox" value="5.7.3.3"  class="clause"><b>5.7.3.3.</b> reconstruct, replace, or correct the materials or work; or<br/><br/>
    <input type="checkbox" value="5.7.3.4"  class="clause"><b>5.7.3.4.</b> not deliver the materials or work to the site.<br/><br/>
    <input type="checkbox" value="5.7.4"  class="clause"><b>5.7.4.</b>     The Subcontractor must comply with all such directions within the times specified by the Contractor and at no cost to the Contractor.<br/><br/>
    <input type="checkbox" value="5.8"  class="clause"><b>5.8.</b>         Cost of Rectification or Compliance<br/><br/>
  </div>
            </div>
    ...
    color: white !important;
    border: none !important;
    border-radius: 10vh !important;" class="btn btn-default" id="disagreeButton" data-dismiss="modal" onclick="toggle=0;$('.form-control-remove').show();$('.form-control-feedback').hide();$('#clause_hide').val('');">Disagree</button>
