(function($) {
    ...
    */
    ...
    $('#features_3_arrow_next').click(function () { $.scrollTo('#gallery',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
     $('#gallery_arrow_back_2').click(function () { $.scrollTo('0px',1000,{easing:'easeInOutExpo',offset:0,'axis':'y'});});
    ...
    */
    Animations: function() {
        ...
        $('#testino').waypoint(function() {
            setTimeout(function(){$('#testinomial').addClass('animated fadeInDown')},0);
             setTimeout(function(){$('#test').addClass('animated fadeInDown')},300);
            // setTimeout(function(){$('#service_2').addClass('animated fadeInDown')},500);
            // setTimeout(function(){$('#service_3').addClass('animated fadeInDown')},700);
        }, { offset: '50%' });
        ...
        $('#features_3').waypoint(function() {
            setTimeout(function(){$('#gallery_carousel_web').addClass('animated fadeInDown')},0);
          ...
          $('#web').waypoint(function() {
            setTimeout(function(){$('#web_intro').addClass('animated fadeInDown')},0);
            setTimeout(function(){$('#gallery_carousel_web').addClass('animated fadeInUp')},700)
    ...
    * Carousel
    */
    CarouselGlass: function() {
        $('#owl-gallery-glass').owlCarousel({
            items : 5,
            itemsDesktop : [1199,5],
            itemsDesktopSmall : [980,5],
            itemsTablet: [768,5],
    ...
    * Nivo Lightbox
    */
    LightboxGlass: function() {
        $('#owl-gallery-glass a').nivoLightbox({
            effect: 'fall',                             // The effect to use when showing the lightbox
        });
    },

     CarouselWeb: function() {
        $('#owl-web').owlCarousel({
            items : 5,
            itemsDesktop : [1199,5],
            itemsDesktopSmall : [980,5],
    ...
    * Nivo Lightbox
    */
    LightboxWeb: function() {
        $('#owl-web a').nivoLightbox({
            effect: 'fall',                             // The effect to use when showing the lightbox
        });
    },
