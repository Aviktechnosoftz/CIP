...
// echo "select name from tbl_access INNER JOIN tbl_project_register ON tbl_access.id=tbl_project_register.access_id where project_id=".$_SESSION['admin']." group by name";
$obj4=$conn->query("Select * FROM tbl_employer where is_deleted=0 AND project_id=".$_SESSION['admin']." order by company_name");
...
<div class="Main_Form2">
  <div class="col-md-12">
	<form  name="site_form" id="myform"  method="POST" enctype="multipart/form-data" class="well form-horizontal well_class" autocomplete="off">
		<fieldset>
			<div class="row">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="text" id="emp_contact" class="form-control form-control-left-radius"  value="<?php echo $_POST['x'] ?>" readonly>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="form-group">		
					<div class="col-sm-12">
						...
						<input type="Email" id="email"  class="form-control form-control-left-radius" readonly>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-md-12">
						...
						<!-- <textarea placeholder="Enter Address Here.." rows="2" class="form-control form-control-left-radius" name="empe_add" id="person_address" onchange="validAdd()" required></textarea> -->
						...
						<script>
							/*function validAdd()
							{
								var add = $('#person_address').val();
								alert(add);
								var letterNumber = /[^0-9a-zA-Z]g/;
								if($('#person_address').val().match(letterNumber))
								{
									alert(add+" in");
									return true;
								}
						...
						<!-- <div id="error_address" style="display: none;margin-top: 3px;font-size: 12px;color:#E74C3C">
							<label><i>Street name and Number Suburd State Post Code</i></label>
				...
				<div class="form-group">		
					<div class="col-sm-12">
						...
						<select id="position" style="height: 34px;display: block;width: 100%;padding-left:20px;font-size: 14px;line-height: 1.42857143;color: #555;background-color: #eee;background-image: none;border: 1px solid #eee;border-radius: 20vh;" name="empe_position" required>
							<option value=""> Please Enter Employee Work Title</option>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12 ">
						...
						<input type="text" placeholder="Please Enter Contact Person's Name" class="form-control form-control-left-radius" name="empe_emrg_name" required>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="form-group">					
					<div class="col-sm-12 ">
						...
						<input type="text" placeholder="Please Enter Name" class="form-control form-control-left-radius" name="empe_emrg_relation" required>
					</div>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							...
							<input type="text" placeholder="Please Enter Training Provider Name" name="provider_name" class="form-control form-control-left-radius" required> 
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="form-group">		
						<div class="col-sm-12">
							...
							<input  type="text" name="card_number" class="form-control form-control-left-radius" id= "pin_insert" placeholder="Please Enter General Construction Induction Card"  onchange="pin_generate()" minlength="4" required>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							...
							<span class="glyphicon glyphicon-eye-open" id="viewer" style="display:none;left:-10%;position:relative;"></span>
							<div id="uploader"  onclick="$('#file_1').click()" >
				                ...
				                onchange="document.getElementById('preview1').src = window.URL.createObjectURL(this.files[0]); $('#viewer').show();" required><br>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer2" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer3" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer4" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">					
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer5" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer6" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer7" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer8" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer9" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer10" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer11" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer12" style="display:none;left:-10%;position:relative;"></span>
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer13" style="display:none;left:-10%;position:relative;"></span>
						...
						<div class="col-sm-6">
							<p style="text-align: center;">
							<div style="text-align: center;">
							<span class="glyphicon glyphicon-eye-open" id="viewer14" style="display:none;left:-10%;position:relative;"></span>
