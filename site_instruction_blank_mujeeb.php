...
<div class="main_form_header">
  <div class="col-md-12">
    <div class="col-md-6 main_title_container">
        ...
        <label class="control-label" style="padding-left: 0px;"><span class="project_title">Site Instruction Form&nbsp;<?// echo $project_name->project_name ?> </span></label>
...
<div class="Main_Form2">
  <div class="col-md-12">
    <form class="well form-horizontal well_class" action=" " method="post"  id="contact_form"  enctype="multipart/form-data" style="border: none">
      <fieldset>
