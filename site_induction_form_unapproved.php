...
if(isset($_REQUEST['reject']) == true)
{
  ...
  $to="shashank.r@aviktechnosoft.com".",".$_REQUEST['empe_email'];
       $msg = "<html> 
			  <body>
			  Hello HSR / SM, <br/><br/>
			  ".$get_email->site_induction_msg."<br/>
			Site Induction form ".$induction." is Rejected.<br/><br/>
			  ...
			  <a href ='https://cipropertyapp.com/site_induction_resubmitted_direct.php?resubmitted_form=".$s."&u=".$_SESSION['admin_user']."&p=".$_SESSION['admin_pass']."&ad=".$_SESSION['admin']."&ind=".$_SESSION['induction']."&pi=".$_SESSION['pin']."&p_name=".$_SESSION['project_name']."'><input type=\"button\" value=\"Review\"> </a><br/><br/>
  		...
  		<fieldset>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">		
						<label>DATE</label>
						<input type="text" class="form-control form-control-left-radius" value="<?echo date("d-m-Y", strtotime("$test->created_date"));?>" readonly>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						<p class="h4" style="text-align: left;">EMPLOYER DETAILS/ BUSINESS DETAILS</p>								
					</div>							
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-12">
						...
						<input type="text" id="address"  class="form-control form-control-left-radius" value="<? echo $employer_name->address ?>" readonly> 
					</div>
				</div>
			</div>
 ...
 -->
  ...
  <li>
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-9 col-md-9">
						<p class="text"> Do you have a medical condition that poses a health or safety risk to you or others on site?<br><br> e.g. Diabetes, Deafness, Heart/Lung Condition, Allergy etc.)</p>								
					</div>							
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						<p style="text-align: center;">
							...
							<img src ="" class="preview1" id="preview0" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
	    			...
	    			<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img src="" class="preview2" id="preview1" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  onerror="$(this).css('background-image', 'url(Document.png)');" />
				...
				<div class="form-group">
					<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img src="" class="preview3" id="preview2" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
	    			...
	    			<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview4" id="preview3" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
				...
				<div class="form-group">
					<div class="col-sm-6">
    					<p style="text-align: center;">
  						...
  						<img class="preview5" id="preview4" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview6" id="preview5" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
							<img class="preview7" id="preview6" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;"  onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
					<img class="preview8" id="preview7" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview9" id="preview8" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
							<img class="preview10" id="preview9" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview11" id="preview10" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview12" id="preview11" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
			...
			<div class="row">
				<div class="form-group">
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview13" id="preview12" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
    ...
    <div class="col-sm-2">
					...
					<div class="col-sm-6">
						<p style="text-align: center;">
						<img class="preview14" id="preview13" alt="" style=" width: 120px;height: 120px;background-position: center center;background-size: cover; border-radius:20px ;display: inline-block;" onerror="$(this).css('background-image', 'url(Document.png)');" />
				...
				<div class="row">
					<div class="form-group">
						<div class="col-sm-12">
							...
							<p class="h5" style="text-align: left;font-weight: 100;">I <input type="hidden" id="declaration_name" name="declaration_name" style="border: 0;text-align: center;background: #e4e4e4;" readonly><? echo $test->given_name; ?><? echo $test->surname; ?> &nbsp;&nbsp;&nbsp;&nbsp;<span color: #272727;"> certify the following:</span> </p>
...
if(typeof checkboxValArry == "undefined" || checkboxValArry == null || checkboxValArry.length <= 0)
{ 
document.getElementById('resubmit').disabled=true;
document.getElementById('submit').disabled=false;
toggle=0;
...
.chec{
    ...
    overflow-y: scroll;
	  ...
	  <!-- The Modal -->
 <div id="myModal" class="modal chec">
				...
				<a class="help-button  down14 fa fa-download" id="onerrorm13" style="display:none"    download></a>
											  <img class="modal-content modal-content-image north" onerror="javascript:this.src='Document.png';" id="img01"  >
											  <div id="caption"></div>
	</div>
	</div>
	</div>
