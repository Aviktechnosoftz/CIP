              ...
              <table id="mytable" class="table table-bordred blue_table_label" style="background-color: #3C3C3E;color: #fff;margin-top: -6px;">   
                <tbody> 
                  <tr class="content_tr" id="content_task_<?=$row_main_detail_task->id ?>"  style="height: 100px;" >
                    ...
                    <div>Subcontractor Name:&nbsp<?=$get_emp_task->email_add_all;?></div>
                    <div>
                      <br><div style="width: 70%;float: left;">Target Date: <?=$get_action_status_task->target_date; ?></div>
                      <div style="width: 30%;float: right;">Actual Date: <?=$get_action_status_task->actual_date; ?></div>
                    </div>
                    </td>
                    ...
                    <?
                      ...
                      <span  class="glyphicon glyphicon-ok not-selected1" id="gif_ok"></span>  
                       <span  class="glyphicon glyphicon-remove not-selected2" id="gif_remove"></span>   
                      <?
                        }
                      ?>
                ...
                <tbody>
                  <tr class="content_tr" id="content_<?=$row_main_detail->id ?>" style="height: 100px;" >
                    ...
                    ?>
                      ...
                      <br><div>
                        <div style="width: 70%;float: left;">Target Date: <?=$get_action_status->target_date ?></div>
                        <div style="width: 30%;float: right;">Actual Date: <?=$get_action_status->actual_date ?></div>
                      </div>
                      <? }?>
                    </td>
          ...
          <tr class="content_tr" id="mod_btn_3" data-toggle="modal" data-target="#myModal2_action_<?= $row_action_required_detail->main_id ?>"  data-temp="<?echo $row_action_required_detail->action_required;?>" data-task="<?if($row_action_required_detail->is_task_obs == '1') {echo $row_action_required_detail->task_desc;} else echo $row_action_required_detail->main_taskdesc;  ?>">
            ...
            <td style="text-align: center;"><?if($row_action_required_detail->is_task_obs == '1') {echo $row_action_required_detail->task_desc;} else echo $row_action_required_detail->main_taskdesc;  ?>
              <div id="span2" class="t r" style="text-align: center;">
                <br>&nbsp;<b>Action Required:</b><? echo $row_action_required_detail->action_required;?>
                <br>&nbsp;<b>Action Complete:</b><?= $row_action_required_detail->action_complete; ?>
                <br>&nbsp;<b>Resp:</b><?= $get_resp_email->email_add; ?><br>&nbsp;<b>Target Date:</b><?= $row_action_required_detail->target_date?>
              </div>
              <div>
