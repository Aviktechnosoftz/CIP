<?php
//error_reporting(1);
include('design_management_plan.php');
//error_reporting(0);
session_start();
...
<iframe src="https://docs.google.com/gview?url=http://cipropertyapp.com/Design_Management_Plan2.docx&embedded=true" style="    height: 81vh;
