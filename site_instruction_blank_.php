          ...
          <div class="form-group">
            <div class="col-md-12 zeropadding"> 
              <div class="col-sm-3" style="">
                <span class="glyphicon glyphicon-eye-open" id="viewer" style="display:none;left:65px;position:relative;top:25px">
                </span>
              ...
              <div class="col-sm-3 text-center">
                <span class="glyphicon glyphicon-eye-open" id="viewer2" style="display:none;left:65px;position:relative;top:25px">
                </span>
              ...
              <div class="col-sm-3 text-center">
                <span class="glyphicon glyphicon-eye-open" id="viewer3" style="display:none;left:65px;position:relative;top:25px">
                </span>
              ...
              <div class="col-sm-3 text-right">
                <span class="glyphicon glyphicon-eye-open" id="viewer4" style="display:none;left:20px;position:relative;top:25px">
                </span>
...
<input type="hidden" name="req_date2" id="date2" class="form-control"  readonly placeholder="DD/MM/YYYY" />
      ...
      <div id="myModal" class="modal">
        <div class="modeliconbackgroundcolor">
          ...
          <a class="help-button  downloadupaddinvoice1 fa fa-downlode" id="onerrorm1"   download style="display:none">Download 
          </a>
          <a class="help-button  downloadupaddinvoice2 fa fa-downlode" id="onerrorm2"   download style="display:none">Download 
          </a>
          <a class="help-button  downloadupaddinvoice3 fa fa-downlode" id="onerrorm3"   download style="display:none">Download 
          </a>
          <a class="help-button  downloadupaddinvoice4 fa fa-downlode" id="onerrorm4"   download style="display:none">Download 
          </a>
        </div>
