...
$obj4=$conn->query("Select * FROM tbl_employer where is_deleted=0 AND project_id=".$_SESSION['admin2']."");
          ...
          <div class="row">
            ...
            <div class="form-group">
              <div class="col-sm-12">
                  ...
                  <input type="Date" name="gcic_issue"  class="form-control form-control-left-radius" min="1997-01-01" required style="text-align: left;">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              ...
              <span class="glyphicon glyphicon-eye-open" id="viewer" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer2" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer3" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer4" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">         
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer5" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer6" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer7" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer8" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer9" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer10" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer11" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer12" style="display:none;left:300px;position:absolute;top:25px"></span>
        ...
        <div class="row">
          <div class="form-group">
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer13" style="display:none;left:300px;position:absolute;top:25px"></span>
            ...
            <div class="col-sm-6">
              <p style="text-align: center;">
              <div style="text-align: center;">
              <span class="glyphicon glyphicon-eye-open" id="viewer14" style="display:none;left:300px;position:absolute;top:25px"></span>
