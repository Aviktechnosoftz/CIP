...
<div id="container" >
 <div id="container">
    ...
    top: 35.6vh;
    left:400px;
    width: 72.5vw;background-color: #f5f5f5   ;">
         <div>
      <center>
    <div style="">
...
<strong style='font-size:2.0rem'>Edit Employer</strong><br><br>
    ...
    padding: 16px;' >
        ...
        <input type="text" list="browsers" name="empe_trade" value="<?= $obj->Tread ?>" />
