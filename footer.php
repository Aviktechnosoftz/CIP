...
<div class="">
    <span style="float: left;        padding-left: 2.8vw; ">
    <img src="image/logo_foot_2.png" style="   
    width: 8vw;
...
<span style="
    ...
    padding-top: 2vh;
    position: absolute;
    /* font-family: 'Avenirnext'; */"><span class="bottom_text" style="font-family: 'Avenirnext';">Date: &nbsp <?=date("jS M Y ") ?></span></span>
<span style="float: right;    margin-right: 8.3vw;


"> <img src="image/footer_new.png" style="position: absolute;  bottom: 1vh;
    width: 6vw;
    "> </span>
</div>
