...
<body class="fullBackground">
  ...
  <div class="login">
   ...
   <center>  <p style="color: white;font-size: 4vh;font-family: 'Helvetica_Nue_thin';">Sign In</p></center>
  ...
  <div style="text-align: center;margin-right: 2vw;"><img id="img_line" 
src="image/Line 1.png" height="1vh"></div>   <div
class="forgot_pass" style="text-align: center;height: 4vh"> <p
id="forgot_text">Forgot Password? <span><button
id="forgot_btn">Go</button></span></p></div>



    <div id="error" style="<? if($err!='1'){ echo 'display:none;';}?>height:60px; top:5px; color:#00FCE9;text-align: center;"> 
      <span style="font-size:2vh">Please enter valid Pin Number/ Password</span>
      </div>
...
@font-face {
  font-family: 'Helvetica_Nue_thin';
   src: url('admin/assets/fonts/HelveticaNeue-Thin.otf');
}
...
$('#loading').html('<img src="image/loader3.gif" style="height: 2vh;padding-right: 1vh;">');
$('#loading').show();
  ...
  function index_validate(id,pin,project_id)
  {
     ...
     $.ajax({
                      ...
                      success: function(data) {
                        ...
                        window.location="header_home.php";
...
{    background-color: #DF5430 !important;  background-image: none;    -webkit-text-fill-color: white !important ;-webkit-box-shadow: 0 0 0 30px #DF5430 inset !important} 
</style>
</html>