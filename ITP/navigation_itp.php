  ...
  <li><a class="button_1" ><img src="../image/Safety.png" style="height: 6vh;width: 6vh"><br><span class="text1">Safety</span></a>
    <ul class="gradient_menu gradient108">
      ...
      <li class="first_item"><a class="with_arrow" title="">Site Safety Management Plan</a>
        ...
        <li><a title="" href="#" class="temp_color" >Site Safety Management Plan Signing Page</a></li>
        <li><a title="" href="#" class="temp_color" >Site Layout and Evacuation Plan</a></li>
        <li><a title="" href="#" class="temp_color" >Internal Traffic Management Plan</a></li>
    ...
    <!--   <li class="last_item"><a class="with_arrow" title="">Site Induction Register</a>
      ...
      <li class="last_item"><a class="with_arrow" title="" class="temp_color" >Control Centre</a>
      <ul class="gradient_menu gradient108">
    ...
    <!--   <li><a title="" href="../employee.php">Site Induction Register</a></li> -->
      ...
      <li class="last_item"><a class="with_arrow temp_color" title="">Subbie Packs</a>
    ...
    <li class="last_item"><a class="with_arrow" title="" >Site Inductions</a>
      ...
      <li><a class="with_arrow temp_color" title="">Ceiling Induction</a>
        <ul class="gradient_menu gradient252">
        <li class="first_item"><a title="" class="temp_color"  href="../visitor_induction_blank_demo.php">Blank Ceiling Induction Form</a></li>
      ...
      <li class="first_item"><a class="with_arrow" title="">Visitor Induction</a>
       ...
       <!--  <li class="last_item"><a title="">Visitor Induction Video</a></li> -->
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Driver Induction</a>
        <ul class="gradient_menu gradient108">
...
<!--       <li><a class="with_arrow" title="">Permit To Work Register</a>
      ...
      <li class="last_item"><a title="">Other Register (Still to come)</a></li> -->
            ...
            <li class="last_item"><a class="with_arrow temp_color" title="">Permit to Work</a>
      <ul class="gradient_menu gradient108"  style="overflow-y:auto;height: 35vh;overflow-x: hidden;" id="main_parent_2">
      <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Work Authorisation</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="last_item"><a title="" class="temp_color" >Permit to Work Authorisation Register</a></li>
         ...
         <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Excavate</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Hot Work</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Enter Confined Space</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Enter Cold Room / Freezer</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Penetrate Surface</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Access Ceiling</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Isolate Services</a>
        <ul class="gradient_menu gradient108">
        <li class="first_item"><a title="" class="temp_color" >New Permit to Access Ceiling</a></li>
        <li><a title="" class="temp_color" >Approved Permit to Access Ceiling</a></li>
        <li class="last_item"><a title="" class="temp_color" >Permit to Access Ceiling Register</a></li>
        </ul></li>
          <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Energise Electrical</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="last_item"><a title="" class="temp_color" >Permit to Energise Electrical Register</a></li>
          ...
          <li class="first_item"><a class="with_arrow temp_color" title="">Permit to Energise Services</a>
        <ul class="gradient_menu gradient108">
       ...
       <li class="last_item"><a class="with_arrow temp_color" title="">Safety Meetings</a>
      <ul class="gradient_menu gradient108">
     
        <li class="first_item"><a class="with_arrow temp_color" title="">OH&S Committee Constitution</a>
         <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">OH&S Safety Committee</a>
         <ul class="gradient_menu gradient108">
    ...
    <li class="last_item"><a class="with_arrow temp_color" title="" style="">Weekly Checklist</a>
      ...
      <li class="first_item">
      <a class="temp_color" title=""  >Weekly Inspection Checklist</a></li>
      <li class="first_item">
      <a class="temp_color" title=""  >Hoist Daily Checklist</a></li>
            <li class="first_item">
      <a class="temp_color" title=""  >Precast Panel Erection Sign Off</a></li>
                  <li class="first_item">
      <a class="temp_color" title=""  >Pre Roof Access Checklist</a></li>
                        <li class="first_item">
      <a class="temp_color" title=""   >Daily Roof Sign Off</a></li>
       <li class="first_item">
      <a class="temp_color" title=""  >Structural Steel Erection Daily Sign Off</a></li>
      <li class="first_item">
      <a class="temp_color" title=""   >Crane Lift Plan</a></li>
      <li class="last_item">
      <a class="temp_color" title=""  >Noise Hazard Identification Checklist</a></li>

      </ul><!-- </div> --></li>

      <li class="last_item"><a class="with_arrow temp_color" title="">Safety Checklist</a>
    ...
    <a class="with_arrow temp_color" title="">Evacuation Test Checklist</a>
      ...
      <li class="first_item"><a class="with_arrow temp_color" title="">Nurse Call Inspection Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Air Conditioning Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Fire Protection Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Spill Kit General Purpose Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Site Security Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">First Aid Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Scaffold Inspection Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Hoist Inspection Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Roof Access Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="last_item"><a title="" class="temp_color" >Roof Access Checklist Register</a></li>
         ...
         <li class="first_item"><a class="with_arrow temp_color" title="">Noise Hazard Identification Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Roof Sign Off Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Structural Steel Erection Signoff Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Crane Lift Plan Checklist</a>
        <ul class="gradient_menu gradient108">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Precast Panel Erection Sign off Checklist</a>
        <ul class="gradient_menu gradient108">
      ...
      <li class="last_item"><a title="" href="../safety_statistics.php">Safety Statistics Weekly & Monthly</a></li>
            ...
            <li class="last_item"><a class="with_arrow temp_color" title="" style="">Audits & Reviews</a>
           <!-- <div class="" style="position: absolute;display: none;z-index: 10;top: 20px;left: 30px"> -->
      ...
      <li class="first_item"><a class="with_arrow temp_color" title="">Senior Management Site Visit Report</a>
        <ul class="gradient_menu gradient108" style="">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Site Manager/Supervisors Weekly Project Review</a>
        <ul class="gradient_menu gradient108" style="">
        ...
        <li class="first_item"><a class="with_arrow temp_color" title="">Project Managers Monthly</a>
        <ul class="gradient_menu gradient108" style="">
...
<li class="first_item" ><a style="width: 200px"  title="" href="">Quality Management Plan</a></li>
     ...
     <li class="first_item" ><a style=""  class="with_arrow temp_color" title="" href="">Meeting Minutes</a>
	  <ul class="gradient_menu gradient108">
	   <li>
		...
		<li ><a style="" class="temp_color"  title="" href="#">Project Team Meeting Minutes</a>
		<ul class="gradient_menu gradient108">
...
<ul class="gradient_menu gradient108">
 <li class="first_item" ><a style="" class="" title=""  href="../environment_plan_iframe.php" >Environmental Management Plan</a>
      <li class="first_item" ><a style="" class="with_arrow temp_color" title="" href="">Site Environmental Control Checklist</a>
...
<li><a style=""  title="" class="temp_color" href="#">Design Meeting Minutes</a>
		<ul class="gradient_menu gradient108">
		   <li ><a style=""  title="" href="#" class="temp_color" >New Design Meeting Minutes</a></li>
		   <li ><a style=""  title="" href="#" class="temp_color" >Approved Design Meeting Minutes</a></li>
		   <li ><a style=""  title="" href="#" class="temp_color" >Design Meeting Minutes Register</a></li>
		</ul></li>
</li>

<li>
                     <a style=""  title="" href="#" class="temp_color">Design Drawing & Specifications  <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal2">Add</button></a>
                    ...
                    <ul class="gradient_menu gradient108" style="overflow-y:auto;overflow-x: hidden;">
                       <? while($row_sub_head=$get_sub_head->fetch_object()){ ?>
                        ...
                        <div style="width: 200px; word-wrap: break-word;float: left" id="sub_head_hover">
                          ...
                          <a title="" ><?= $row_sub_head->title?></a>

                        </div> 

                        <div style="width:50px;float: right;">
                          <button type="button" class="btn btn-default btn-xs" style="float: right;margin-top: 5px;outline: none" onclick="delete_sub_head(<?=$row_sub_head->id ?>);">Delete</button>
                        </div>
                        </div>
...
<li class="first_item" ><a style="" class="temp_color" title="" href="">Contracts Administration Management Plan</a></li>
  ...
  <li class="last_item">
		...
		<li class="first_item" ><a class="with_arrow temp_color" title="" >Back Charge</a>
        <ul class="gradient_menu gradient108">
