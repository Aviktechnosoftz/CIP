            ...
            <div class="col-md-2 col-sm-4 sidebar1">
               <!--  <div class="logo">
                ...
                <div class="left-navigation">
                    <ul class="list">
                        <h5><strong>SITE INSTRUCTION</strong></h5>
                        <li><a href="site_instruction_blank.php">New Site Instruction Form</a>
                        </li>
                        <li><a href="site_instruction_approved.php">Aprroved Site Instruction Forms</a>
                        </li>
                        <li><a href="site_instruction_register.php">Site Instruction Register</a>
                        </li>
